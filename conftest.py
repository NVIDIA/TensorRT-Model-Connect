def pytest_addoption(parser):
    opts = [
        ...
        ('--e2e-skip-waived-xfail', dict(action='store_true', default=False,
                                         help='Skip centralized XFAIL waives before build')),
        ('--e2e-skip-non-gating', dict(action='store_true', default=False,
                                      help='Skip E2E cases that only provide non-green smoke coverage')),
