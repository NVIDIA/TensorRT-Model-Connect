...
| Keep models loaded for local applications | [Serve Local Models](serve-local-models.md) | Local completion, transcription, and Realtime APIs backed by persistent native workers. |
