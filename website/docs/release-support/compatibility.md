...
| Native runtime | Use matching core/backend/family DSOs and a compatible TensorRT/CUDA cohort. |
| Platform specialization | Match the exact family offload implementation, target, and options; do not generalize it to native platform support. |
