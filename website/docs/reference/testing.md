...
not yet provide a native Talker. Its active premerge/nightly case exercises
native Thinker text generation with an L4 non-empty-output invariant; the
support matrix remains red, and this does not claim L1 audio parity or audio
