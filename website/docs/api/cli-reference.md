...
SAM2-HOI video tracking intentionally has no generic task CLI command. It uses
the model-owned fixed five-JPEG C ABI documented in
[C++ API and C-Linkage Subset](cpp-api.md#sam2-hoi-video-c-abi).
