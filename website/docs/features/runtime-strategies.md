...
| Perception | `dinov3_image_feature_extraction`, `moge_monocular_geometry`, `segformer_segmentation`, `sam_prompted_segmentation`, `sam3_prompted_segmentation`, `timm_vit_image_classification`, `timm_resnet_image_classification`, `timm_regnet_image_classification`, `timm_repvgg_image_classification`, `timm_inception_image_classification`, `timm_mnasnet_image_classification`, `timm_densenet_image_classification`, `timm_efficientnet_image_classification`, `timm_mobilenetv3_image_classification`, `timm_vgg_image_classification` |
