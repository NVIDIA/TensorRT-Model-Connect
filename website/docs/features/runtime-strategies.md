...
| Perception | `dinov3_image_feature_extraction`, `segformer_segmentation`, `sam_prompted_segmentation`, `sam2_bbox_video_tracking`, `sam2_hoi_video_tracking`, `sam3_prompted_segmentation`, `timm_vit_image_classification` |
...
runtime model manifests. At this revision it contains 84 unique keys for 83
runtime owners.
