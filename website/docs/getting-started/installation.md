...
| --- | --- |
| Release wheel | Linux aarch64, Python 3.12, glibc 2.39 or newer, and official TensorRT 11.1.0.106. |
...
[Quick Start](quick-start.md), where the Python builder and native CLI are used
through their separate entry points.
