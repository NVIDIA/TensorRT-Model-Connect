...
disables unrelated backends and benchmarks, and enables the distributable
build mode. `-BuildTests` also runs the portable DLL loader, backend loader,
and CLI argument tests. Its outputs are:
