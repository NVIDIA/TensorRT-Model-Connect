  ...
  ```json
  {
    "model-proof-status.json": {
      ...
      "steps": {
        ...
        "e2e_snapshot_regression": {"status": "skipped", "evidence": "no selected snapshot_regression oracle"},
        "e2e_functional_invariant": {"status": "skipped", "evidence": "no selected functional_invariant oracle"},
