...
def scheduler_modules(request: pytest.FixtureRequest):
    ...
    package = import_module(f"tools.families.{family}.schedulers")
    flow = import_module(f"tools.families.{family}.schedulers.flow_match_euler")
    base = import_module(f"tools.families.{family}.schedulers.base")
