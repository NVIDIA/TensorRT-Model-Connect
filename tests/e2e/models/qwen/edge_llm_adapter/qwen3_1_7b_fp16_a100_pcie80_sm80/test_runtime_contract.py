...
def test_runtime_rejects_nonexact_vocab_size(tmp_path: Path, fake_runtime: Path) -> None:
    artifact, _ = _staged_capsule(tmp_path, fake_runtime)
...
int main(int argc, char** argv) {
    ...
    request.model_id = "Qwen/Qwen3-1.7B";
    request.profile_id = "qwen3-1.7b-fp16--a100-pcie80-sm80--edgellm0.9-trt11";
    ...
    if (first.text != "fake:hello" || second.text != "fake:world" ||
        ...
        pipeline->model_id() != std::string("Qwen/Qwen3-1.7B") ||
