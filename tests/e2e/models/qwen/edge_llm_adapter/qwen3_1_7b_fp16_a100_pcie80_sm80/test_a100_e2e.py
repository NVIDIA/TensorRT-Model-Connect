...
"""Public A100 qualification for the Qwen3 1.7B EdgeLLM capsule."""
...
_DEPENDENCY_LOCK = (
    ...
    / "qwen3_1_7b_fp16_a100_pcie80_sm80/dependency.lock"
)
...
_PUBLIC_EDGE_BUILD_ENVIRONMENT = {
    "TRTMC_EDGE_LLM_SOURCE_DIR": "_TRTMC_INTERNAL_QWEN3_1_7B_EDGE_LLM_SOURCE_DIR",
    "TRTMC_EDGE_LLM_BUILD_DIR": "_TRTMC_INTERNAL_QWEN3_1_7B_EDGE_LLM_BUILD_DIR",
}
...
def test_public_build_inspect_and_run_delegate_to_edgellm(tmp_path: Path) -> None:
    ...
    bundle = tmp_path / "qwen3-1.7b-edge.trtfb"
    build_command = [
        str(binary),
        "build",
        _MODEL_ID,
    ...
    installed_python_bundle = tmp_path / "qwen3-1.7b-edge-installed-python.trtfb"
