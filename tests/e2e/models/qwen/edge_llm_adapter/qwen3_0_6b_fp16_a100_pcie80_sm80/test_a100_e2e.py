...
"""Public A100 qualification for the Qwen3 0.6B EdgeLLM capsule."""
...
_IMPLEMENTATION_ID = "qwen3-0.6b-fp16.tensorrt-edge-llm-v0.9.trt10.a100-pcie80-sm80"
...
_DEPENDENCY_LOCK = (
    ...
    / "qwen3_0_6b_fp16_a100_pcie80_sm80/dependency.lock"
)
...
_PUBLIC_EDGE_BUILD_ENVIRONMENT = {
    "TRTMC_EDGE_LLM_SOURCE_DIR": "_TRTMC_INTERNAL_QWEN3_06B_EDGE_LLM_SOURCE_DIR",
    "TRTMC_EDGE_LLM_BUILD_DIR": "_TRTMC_INTERNAL_QWEN3_06B_EDGE_LLM_BUILD_DIR",
}
...
def test_public_build_inspect_and_run_delegate_to_edgellm(tmp_path: Path) -> None:
    ...
    assert descriptor["profile_id"] == (
        "qwen3-0.6b-fp16--a100-pcie80-sm80--edgellm0.9-trt10"
    )
    ...
    assert "Hidden size:        1024" in inspect.stdout
    ...
    warm_bundle = tmp_path / "qwen3-0.6b-edge-warm-profile.trtfb"
    warm_build_command = [
        str(binary),
        "build",
        _MODEL_ID,
