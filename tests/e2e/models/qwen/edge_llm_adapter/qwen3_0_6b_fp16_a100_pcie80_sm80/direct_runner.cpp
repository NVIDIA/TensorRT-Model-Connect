...
static_assert(TRT_MAJOR_ENTERPRISE == 10 && TRT_MINOR_ENTERPRISE == 16 &&
                  TRT_PATCH_ENTERPRISE == 1 && TRT_BUILD_ENTERPRISE == 11,
              "qualification requires TensorRT 10.16.1.11 headers");
#else
static_assert(NV_TENSORRT_MAJOR == 10 && NV_TENSORRT_MINOR == 16 && NV_TENSORRT_PATCH == 1 &&
                  NV_TENSORRT_BUILD == 11,
              "qualification requires TensorRT 10.16.1.11 headers");
#endif
