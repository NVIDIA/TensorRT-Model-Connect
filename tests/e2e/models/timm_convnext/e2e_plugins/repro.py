...
"""timm_convnext model-owned E2E repro command provider."""
...
class TimmRepvggReproCommandProvider:
    """Build timm_convnext TRT repro commands without shared harness branches."""

    @property
    def family_name(self) -> str:
        return "timm_convnext"
...
repro_provider: ReproCommandProvider = TimmRepvggReproCommandProvider()
