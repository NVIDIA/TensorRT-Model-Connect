...
"""Model-owned E2E entrypoint for LeRobot ACT."""
...
_SPEC = importlib.util.spec_from_file_location("lerobot_act_e2e_runner", _RUNNER_PATH)
...
def pytest_generate_tests(metafunc):
    if "case_name" in metafunc.fixturenames:
        ...
        if not case_names:
            pytest.skip("No LeRobot ACT manifests selected", allow_module_level=True)
