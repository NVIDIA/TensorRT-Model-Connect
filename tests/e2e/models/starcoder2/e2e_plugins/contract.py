"""starcoder2-owned E2E contract plugins."""
...
class Starcoder2CausalContinuationPlugin:
    reference_families = ["code_base_completion"]
...
plugin = Starcoder2CausalContinuationPlugin()
