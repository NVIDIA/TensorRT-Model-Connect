...
"""Model-owned E2E entrypoint for MoGe."""
...
_SPEC = importlib.util.spec_from_file_location("moge_e2e_runner", _RUNNER_PATH)
...
def pytest_generate_tests(metafunc):
    if "case_name" in metafunc.fixturenames:
        ...
        if not case_names:
            pytest.skip("No MoGe manifests selected", allow_module_level=True)
