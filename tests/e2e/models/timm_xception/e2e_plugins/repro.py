...
"""timm_xception model-owned E2E repro command provider."""
...
class TimmXceptionReproCommandProvider:
    """Build timm_xception TRT repro commands without shared harness branches."""

    @property
    def family_name(self) -> str:
        return "timm_xception"
...
repro_provider: ReproCommandProvider = TimmXceptionReproCommandProvider()
