...
"""timm_resnet model-owned E2E repro command provider."""
...
class TimmResnetReproCommandProvider:
    """Build timm_resnet TRT repro commands without shared harness branches."""
...
repro_provider: ReproCommandProvider = TimmResnetReproCommandProvider()
