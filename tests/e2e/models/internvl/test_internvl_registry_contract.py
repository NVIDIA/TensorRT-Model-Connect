...
import tensorrt_model_connect.families.internvl.model as model
...
def test_vision_language_runtime_contract() -> None:
    model_module = _model("internvl_chat")
    assert getattr(model_module, "runtime_strategy", None) == "internvl_vision_language"
