...
"""smollm3-owned E2E contract plugins."""
...
class SmolLM3CausalContinuationPlugin:
...
class SmolLM3ChatInstructPlugin:
...
class SmolLM3NativeKvChunkedPrefillRegressionPlugin:
    reference_families = ["smollm3_native_kv_chunked_prefill_regression"]
    ...
    def verify(
        ...
        return make_fail(
            ...
            metrics,
            rule,
            "SmolLM3 native KV chunked-prefill regression contract failed: "
            + ", ".join(failed),
        )


plugin = [
    SmolLM3CausalContinuationPlugin(),
    SmolLM3ChatInstructPlugin(),
