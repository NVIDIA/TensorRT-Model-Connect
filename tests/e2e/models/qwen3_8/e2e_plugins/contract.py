...
"""Qwen3.8-owned multimodal chat contract plugin."""
...
class Qwen38MultimodalChatPlugin:
    reference_families = ["multimodal_chat_qwen38"]
    ...
    def verify(self, trt_output, ref_output, case, threshold):
        ...
        return make_fail(
            ...
            metrics,
            rule,
            f"Qwen3.8 multimodal chat response diverged: NED={ned:.3f}",
        )

plugin = Qwen38MultimodalChatPlugin()
