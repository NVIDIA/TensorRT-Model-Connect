...
"""Qwen3.8-owned debug runner dispatch tests."""
...
def test_qwen3_8_hybrid_dispatch_uses_qwen3_8_owned_runner(tmp_path):
    from tensorrt_model_connect.families.qwen3_8.debug_runner import (
    ...
    path = tmp_path / "qwen3_8_hybrid_tp_dispatch.bundle"
    path.write_bytes(bundle)

    communicator = object()
    with patch(
        "tensorrt_model_connect.families.qwen3_8.debug_runner.HybridTrtRunner",
        return_value="qwen3_8-hybrid-tp-runner",
    ) as mock_runner:
    ...
    assert runner == "qwen3_8-hybrid-tp-runner"
