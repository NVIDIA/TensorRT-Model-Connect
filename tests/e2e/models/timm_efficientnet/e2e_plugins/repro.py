...
"""timm_efficientnet model-owned E2E repro command provider."""
...
class TimmEfficientnetReproCommandProvider:
    """Build timm_efficientnet TRT repro commands without shared harness branches."""
...
repro_provider: ReproCommandProvider = TimmEfficientnetReproCommandProvider()
