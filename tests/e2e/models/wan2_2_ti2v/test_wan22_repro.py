...
from tests.e2e.models.wan2_2_ti2v.e2e_plugins.runners.diffusion import DiffusionMediaRunner
...
def test_runner_cleans_frames_and_uses_strict_native_plugin(
    ...
    from tests.e2e.models.wan2_2_ti2v.e2e_plugins.runners import diffusion
