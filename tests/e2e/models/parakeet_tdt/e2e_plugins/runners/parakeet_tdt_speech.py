...
- speech_to_text: transducer transcription (audio in, text out)
...
class SpeechToTextRunner:
    """TRT strategy runner for speech-to-text (transducer) transcription."""

    @property
    def strategy_name(self) -> str:
        return "parakeet_tdt_speech_to_text"
