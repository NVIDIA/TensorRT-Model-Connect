"""Nemotron Speech Streaming-owned synthetic NeMo archive helpers."""
...
def make_nemo_state_dict(
    ...
    """Create a synthetic NeMo state dict matching the ASR encoder layout."""
    import torch
...
def make_nemo_archive(tmp_path: Path, state_dict: dict, nemo_cfg: dict) -> Path:
    ...
    nemo_path = tmp_path / "nemotron_speech_streaming.nemo"
