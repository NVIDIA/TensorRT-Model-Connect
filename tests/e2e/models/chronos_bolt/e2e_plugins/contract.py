...
"""chronos_bolt-owned E2E contract plugins."""
...
class ChronosBoltTimeSeriesQuantileForecastPlugin:
    ...
    def verify(self, trt_output, ref_output, case, threshold):
        ...
        metrics = {
            ...
            "quantile_dimension_supported": _finite_metric(
...
plugin = ChronosBoltTimeSeriesQuantileForecastPlugin()
