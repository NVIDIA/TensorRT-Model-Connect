...
"""timm_mnasnet model-owned E2E repro command provider."""
...
class TimmMnasnetReproCommandProvider:
    """Build timm_mnasnet TRT repro commands without shared harness branches."""
...
repro_provider: ReproCommandProvider = TimmMnasnetReproCommandProvider()
