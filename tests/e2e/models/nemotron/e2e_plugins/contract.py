...
"""nemotron-owned E2E contract plugins."""
...
class NemotronCausalContinuationPlugin:
...
class NemotronChatInstructPlugin:
...
plugin = [NemotronCausalContinuationPlugin(), NemotronChatInstructPlugin()]
