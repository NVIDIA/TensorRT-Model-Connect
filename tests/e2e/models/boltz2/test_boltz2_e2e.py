...
"""Model-owned E2E entrypoint for Boltz-2."""
...
_SPEC = importlib.util.spec_from_file_location("boltz2_e2e_runner", _RUNNER_PATH)
...
def pytest_generate_tests(metafunc):
    if "case_name" in metafunc.fixturenames:
        ...
        if not case_names:
            pytest.skip("No Boltz-2 manifests selected", allow_module_level=True)
