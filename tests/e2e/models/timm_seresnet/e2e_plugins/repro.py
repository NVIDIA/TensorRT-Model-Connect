...
"""timm_seresnet model-owned E2E repro command provider."""
...
class TimmSeresnetReproCommandProvider:
    """Build timm_seresnet TRT repro commands without shared harness branches."""

    @property
    def family_name(self) -> str:
        return "timm_seresnet"
...
repro_provider: ReproCommandProvider = TimmSeresnetReproCommandProvider()
