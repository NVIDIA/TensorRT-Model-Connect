"""bert-owned encoder/embedding contract plugins."""
...
class BertEmbeddingPlugin:
    reference_families = ['sentence_transformer_embed', 'bge_retrieval_embed']
...
class BertEncoderFeaturesPlugin:
...
plugin = [BertEmbeddingPlugin(), BertEncoderFeaturesPlugin()]
