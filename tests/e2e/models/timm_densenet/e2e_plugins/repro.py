...
"""timm_densenet model-owned E2E repro command provider."""
...
class TimmDensenetReproCommandProvider:
    """Build timm_densenet TRT repro commands without shared harness branches."""

    @property
    def family_name(self) -> str:
        return "timm_densenet"
...
repro_provider: ReproCommandProvider = TimmDensenetReproCommandProvider()
