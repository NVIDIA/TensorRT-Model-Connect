...
def test_qwen3_native_rope_table_has_expected_identities() -> None:
    ...
    """
    mod = _import_with_fake_trt("tensorrt_model_connect.families.z_image.model.components.text_encoder")
...
def test_load_t5_weights_transposes_and_bias_fallback() -> None:
    ...
    """
    mod = _import_with_fake_trt("tensorrt_model_connect.families.flux.model.components.t5_encoder")
