...
"""timm_regnet model-owned E2E repro command provider."""
...
class TimmRegnetReproCommandProvider:
    """Build timm_regnet TRT repro commands without shared harness branches."""
...
repro_provider: ReproCommandProvider = TimmRegnetReproCommandProvider()
