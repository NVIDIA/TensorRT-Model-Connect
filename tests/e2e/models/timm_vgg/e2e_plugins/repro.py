...
"""timm_vgg model-owned E2E repro command provider."""
...
class TimmVggReproCommandProvider:
    """Build timm_vgg TRT repro commands without shared harness branches."""
...
repro_provider: ReproCommandProvider = TimmVggReproCommandProvider()
