...
from tensorrt_model_connect.families.sam3 import timing_cache_data
from tensorrt_model_connect.families.sam3 import vision_encoder_builder
from tests.e2e.models.sam3 import record_timing_cache
...
def test_recorder_cli_builds_only_the_selected_vision_candidate(
    ...
    assert "tests/e2e/models/sam3/record_timing_cache.py" in source_paths
    assert "python/tensorrt_model_connect/families/sam3/timing_cache.py" in source_paths
    assert "python/tensorrt_model_connect/families/sam3/vision_encoder_builder.py" in source_paths
