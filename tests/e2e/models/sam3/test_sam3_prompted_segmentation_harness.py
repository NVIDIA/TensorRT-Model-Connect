...
from tests.e2e.models.sam3.e2e_plugins.comparators.segmentation import (
    PromptedSegmentationComparator,
)
from tests.e2e.models.sam3.e2e_plugins.contract import Sam3SegmentationPlugin
from tests.e2e.models.sam3.e2e_plugins.runners.segmentation import _load_mask_outputs
