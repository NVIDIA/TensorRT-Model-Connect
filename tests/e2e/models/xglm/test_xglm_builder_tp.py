...
FAMILY = 'xglm'
PLUGIN_CLASS = 'XGLMPlugin'
MODEL_TYPE = 'xglm'
TP_SIZE = 4
RAW = {}
EXPECTED_KWARGS = {'activation': 'gelu',
 'mlp_type': 'gelu_fc',
 'norm_type': 'layernorm',
...
def test_xglm_plugin_routes_tp_build(monkeypatch) -> None:
...
def test_xglm_plugin_rejects_quantized_tp(monkeypatch) -> None:
    plugin_mod = importlib.import_module(
        f"tensorrt_model_connect.families.{FAMILY}.plugin")
    monkeypatch.setattr(
        plugin_mod,
