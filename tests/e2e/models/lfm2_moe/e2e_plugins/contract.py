...
"""LFM2-MoE-owned continuation and chat-template contracts."""
...
class Lfm2MoeGreedyContinuationPlugin:
    reference_families = ["lfm2_moe_greedy_continuation"]
    ...
    def verify(
        ...
        return _result(
            ...
            checks,
            "Exact LFM2-MoE cached continuation parity",
        )


class Lfm2MoeChatTemplatePlugin(Lfm2MoeGreedyContinuationPlugin):
    reference_families = ["lfm2_moe_chat_template"]
    ...
    def verify(
        ...
        return _result(
            trt_output.stage_name,
            checks,
            "Pinned LFM2-MoE chat-template parity",
        )


plugin = [
    Lfm2MoeGreedyContinuationPlugin(),
    Lfm2MoeChatTemplatePlugin(),
]
