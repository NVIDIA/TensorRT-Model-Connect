...
"""Strict text/token comparator for LFM2-MoE continuation parity."""
...
class TextComparator:
    ...
    def compare(
        ...
        return CompareResult(
            ...
            message=(
                "Exact LFM2-MoE continuation parity verified"
                if passed
                else "LFM2-MoE continuation diverged from the pinned Transformers oracle"
            ),
        )
