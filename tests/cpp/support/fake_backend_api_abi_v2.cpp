...
class FakeBackendV2 final : public trtmc::IBackend {
  public:
    ...
    const char* name() const override { return "test_api_abi_v2"; }
};
...
extern "C" trtmc::IBackend* trtmc_create_backend_v2() {
    return new FakeBackendV2();
}

extern "C" void trtmc_destroy_backend_v2(trtmc::IBackend* backend) {
    delete backend;
}
