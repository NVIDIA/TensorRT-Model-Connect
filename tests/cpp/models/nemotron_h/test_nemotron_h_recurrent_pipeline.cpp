...
// =============================================================================
//
// Tests the RecurrentPipeline with mock engines and Nemotron-H-owned recurrent
...
static void test_mamba_pipeline() {
    ...
    auto rs = std::make_unique<trtmc::NemotronHRecurrentState>(1, specs, stream);
...
static void test_rwkv_pipeline() {
    ...
    auto rs = std::make_unique<trtmc::NemotronHRecurrentState>(2, specs, stream);
...
static void test_hybrid_pipeline() {
    ...
    auto kv = std::make_unique<trtmc::NemotronHKvCache>(1, 4, 2, stream);
    std::vector<trtmc::NemotronHRecurrentState::TensorSpec> specs = {{"ssm", {4}}};
    auto ssm = std::make_unique<trtmc::NemotronHRecurrentState>(1, specs, stream);
    auto hybrid = std::make_unique<trtmc::NemotronHHybridState>(std::move(kv), std::move(ssm));
