...
#include "runtime/models/qwen3_5/recurrent_output_initializers.h"
...
namespace under_test = trtmc::qwen3_5_recurrent;
...
void test_qwen3_5_recurrent_contracts() {
...
int main() {
    ...
    test_qwen3_5_recurrent_contracts();
