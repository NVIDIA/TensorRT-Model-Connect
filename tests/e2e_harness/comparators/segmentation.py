"""Segmentation and object detection comparators.
...
The primary ``plugin`` is SegmentationComparator. ObjectDetectionComparator is
registered at import time via a direct registry call.
"""
