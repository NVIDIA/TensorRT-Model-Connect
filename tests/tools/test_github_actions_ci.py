...
def test_public_repository_contains_only_public_workflow_orchestration() -> None:
    workflows = REPO_ROOT / ".github" / "workflows"
    private_workflows = (
        "nightly.yml",
        "model-proof.yml",
        "optimized-runtime-proof.yml",
        "performance.yml",
    )
...
def test_model_proof_runtime_uses_isolated_hf_cache_paths() -> None:
...
def test_tensorrt_sdk_build_surface_uses_the_public_ghcr_package() -> None:
...
def test_tensorrt_sdk_private_publisher_is_not_in_public_source() -> None:
...
def test_source_quality_runtime_remains_gpu_free() -> None:
...
def test_model_proof_gpu_allocator_uses_the_whole_machine_lock() -> None:
...
def test_cpp_coverage_runtime_preserves_platform_scope() -> None:
...
def test_python_coverage_runs_allocator_contract_serially() -> None:
...
def test_package_runtime_validates_the_installed_wheel() -> None:
...
def test_model_proof_runtime_isolates_models_and_requires_complete_evidence() -> None:
    runner = _ci_source("model_proof.py", "model_proof_inner.py")
