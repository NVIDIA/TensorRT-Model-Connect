"""Self-tests for tools/diff_segmentation.py — argument parsing and module structure.

diff_segmentation.py is a relatively thin script whose heavy lifting
...
def _import_diff_segmentation():
    import importlib
    return importlib.import_module("diff_segmentation")
...
class TestModuleStructure:
    """Verify that diff_segmentation.py exposes the expected interface."""
...
class TestArgParser:
    ...
    def _build_parser(self):
        """Build the argparse parser from diff_segmentation's main()."""
        import argparse
...
class TestSegmentationMetrics:
    ...
    diff_segmentation.py computes pixel agreement and max logit diff
