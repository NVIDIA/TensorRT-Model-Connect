...
def test_hf_transformers_model_plugins_do_not_name_sibling_families() -> None:
    ...
    family_term_groups = (
        ...
        (
            {"timm_vit", "timm_resnet", "timm_vgg", "timm_mobilenetv3", "timm_efficientnet", "timm_densenet", "timm_mnasnet"},
            (
                "import timm",
                "timm.create_model",
                "_run_image_classification_ref",
...
def test_single_family_e2e_task_sidecars_are_model_owned() -> None:
    ...
    cases = {
        "image_classification": {
            "owners": {"timm_vit", "timm_resnet", "timm_vgg", "timm_mobilenetv3", "timm_efficientnet", "timm_densenet", "timm_mnasnet"},
            "paths": (
