...
try:
    ...
    from tensorrt_model_connect.models.z_image import model as zimg_mod
...
def test_build_components_calls_all_subbuilders(
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.z_image.qwen3_encoder_builder",
        _module(
            "tensorrt_model_connect.models.z_image.qwen3_encoder_builder",
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.z_image.z_image_dit_builder",
        _module(
            "tensorrt_model_connect.models.z_image.z_image_dit_builder",
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.z_image.vae_2d_builder",
        _module(
            "tensorrt_model_connect.models.z_image.vae_2d_builder",
...
def test_build_components_tensor_parallel_builds_rank_denoisers(
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.z_image.z_image_dit_tp_builder",
        _module(
            "tensorrt_model_connect.models.z_image.z_image_dit_tp_builder",
...
def test_fp16_vae_builder_reaches_checkpoint_validation(tmp_path) -> None:
    ...
    from tensorrt_model_connect.models.z_image.vae_2d_builder import (
