...
def _import_qwen3_with_fake_trt(fake_trt: types.SimpleNamespace):
    ...
    checkpoint_module = "tensorrt_model_connect.models.z_image.checkpoint_mapper"
    ...
    with patch.dict(sys.modules, {"tensorrt": fake_trt, checkpoint_module: fake_cm}):
        return importlib.import_module("tensorrt_model_connect.models.z_image.qwen3_encoder_builder")
