...
from tensorrt_model_connect.models.minimax_h3 import provenance
...
BUILD_HELPER = FAMILY_ROOT.parents[3] / "python/tensorrt_model_connect/models/minimax_h3/tests/build_native_components.py"
