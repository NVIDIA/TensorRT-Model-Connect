...
from tensorrt_model_connect.models.minimax_h3.tests import e2e_plugins as minimax_h3_e2e_plugins
from tensorrt_model_connect.models.minimax_h3.tests.e2e_plugins.comparator import comparator
from tensorrt_model_connect.models.minimax_h3.tests.e2e_plugins.reference import (
    _model_snapshot,
    _reference_allow_patterns,
)
from tensorrt_model_connect.config import ModelConfig
from tensorrt_model_connect.models.minimax_h3 import model as family_model
...
_SPEC = importlib.util.spec_from_file_location(
    f"{_MODEL_DIR.parent.name}_e2e_runner",
    _RUNNER_PATH,
)
