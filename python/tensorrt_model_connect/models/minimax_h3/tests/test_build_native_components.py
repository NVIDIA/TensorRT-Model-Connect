...
from tensorrt_model_connect.models.minimax_h3.tests.build_native_components import (
...
def test_main_passes_cli_workspace_to_every_builder(
    ...
    from tensorrt_model_connect.models.minimax_h3.tests import build_native_components
    ...
    package = "tensorrt_model_connect.models.minimax_h3"
