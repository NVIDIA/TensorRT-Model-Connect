...
"""PersonaPlex family-owned build implementation -- speech-to-speech via Moshi.
...
def get_bundle_config_overrides(config: ModelConfig) -> dict:
    ...
    # since config.json is minimal. The model-owned builder passes config
...
def build(model_dir: str, output_path: str, **options) -> None:
    """Build the complete personaplex bundle in the owning family module."""
    import json
    import time
