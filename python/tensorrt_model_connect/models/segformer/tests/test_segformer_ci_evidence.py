...
from tensorrt_model_connect.models.segformer.tests.e2e_plugins.contract import (
    SegformerSegmentationPlugin,
)
from tensorrt_model_connect.models.segformer.tests.e2e_plugins.runners.segmentation import (
    SegmentationRunner,
...
def test_runner_registers_only_human_readable_segmentation_artifact(
    ...
    monkeypatch.setattr(
        "tensorrt_model_connect.models.segformer.tests.e2e_plugins.runners.segmentation.subprocess.run",
        fake_run,
    )
    case = E2ECase(
