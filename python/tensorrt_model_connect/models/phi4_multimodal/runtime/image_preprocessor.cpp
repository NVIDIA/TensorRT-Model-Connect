...
runtime::adapters::io::DecodedImage
phi4_multimodal_decode_image_rgb(const std::string& image_path) {
...
phi4_multimodal_load_and_preprocess_image(const std::string& image_path,
                                          const Phi4MultimodalPreprocessConfig& config) {
    return phi4_multimodal_preprocess_decoded_image(phi4_multimodal_decode_image_rgb(image_path),
                                                    config);
}
