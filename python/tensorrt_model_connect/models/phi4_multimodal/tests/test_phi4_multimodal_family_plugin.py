...
def test_phi4_fp16_matmul_can_request_fp32_accumulation(monkeypatch) -> None:
    module = importlib.import_module(
        "tensorrt_model_connect.models.phi4_multimodal.graph_ops")
...
def test_phi4_vision_linear_requests_fp32_accumulation(monkeypatch) -> None:
    module = importlib.import_module(
        "tensorrt_model_connect.models.phi4_multimodal.phi4mm_vision_builder")
...
def test_longrope_table_applies_frequency_and_attention_factors() -> None:
    from tensorrt_model_connect.models.phi4_multimodal.graph_ops import (
...
class TestPhi4MultimodalPlugin:
    ...
    def test_matches(self):
        import tensorrt_model_connect.models.phi4_multimodal.model as plugin
    ...
    def test_vision_weight_prefix_is_canonicalized(self, tmp_path):
        from tensorrt_model_connect.models.phi4_multimodal.model import (
    ...
    def test_dynamic_hd_preprocessor_shape(self):
        from tensorrt_model_connect.models.phi4_multimodal.vl_debug_runner import (
...
class TestPhi4MultimodalDiscovery:
    ...
    def test_find_plugin(self):
        import tensorrt_model_connect.models.phi4_multimodal.model as model
