...
from tensorrt_model_connect.models.chronos_bolt.tests.e2e_plugins.references.torch_reference import (
    TorchReference,
)
...
def test_torch_reference_time_series_uses_reference_python_subprocess(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "tensorrt_model_connect.models.chronos_bolt.tests.e2e_plugins.references.torch_reference.subprocess.run",
        _fake_run,
    )
