...
def test_qwen3_5_hybrid_dispatch_uses_qwen3_5_owned_runner(tmp_path):
    from tensorrt_model_connect.models.qwen3_5.debug_runner import (
    ...
    path = tmp_path / "qwen3_5_hybrid_tp_dispatch.bundle"
    path.write_bytes(bundle)

    communicator = object()
    with patch(
        "tensorrt_model_connect.models.qwen3_5.debug_runner.HybridTrtRunner",
