...
from tensorrt_model_connect.models.locateanything.tests.e2e_plugins.references import (
...
def test_vl_reference_uses_manual_processor(monkeypatch, tmp_path) -> None:
    ...
    case = E2ECase(
        ...
        inputs={
            ...
            "max_new_tokens": 1,
            "image": "python/tensorrt_model_connect/models/locateanything/tests/data/test_img.jpeg",
        },
    ...
    assert "tensorrt_model_connect.models.locateanything.vl_debug_runner" in script
