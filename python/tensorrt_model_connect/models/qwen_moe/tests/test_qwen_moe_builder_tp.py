...
try:
    qwen_moe_module = importlib.import_module(
        "tensorrt_model_connect.models.qwen_moe.model")
    from tensorrt_model_connect.models.qwen_moe import tp_builder
...
def test_model_entry_has_no_plugin_compatibility_api():
    from tensorrt_model_connect.models import qwen_moe
