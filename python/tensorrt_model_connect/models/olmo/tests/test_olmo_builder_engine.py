...
from tensorrt_model_connect.models.olmo.tests._family_plugin_tester import (
    FamilyPluginTester,
)
from tensorrt_model_connect.models.olmo.tests._family_plugin_test_mixin import (
...
class OlmoPluginTester(FamilyPluginTester):
    ...
    plugin_module = "tensorrt_model_connect.models.olmo.model"
    model_type = "olmo"
