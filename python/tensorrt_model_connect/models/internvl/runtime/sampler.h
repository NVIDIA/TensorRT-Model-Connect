...
// InternVlISampler: token selection abstraction for autoregressive generation.
//
...
//
// InternVlLogitsLocation tells the pipeline whether to D2H transfer logits before
...
class InternVlISampler {
  public:
    ...
    virtual InternVlLogitsLocation logits_location() const = 0;
...
/// Build InternVlSamplingParams from GenerateConfig fields.
...
create_internvl_sampler(const InternVlSamplingParams& params,
                        const InternVlSamplerFactoryOptions& options);
