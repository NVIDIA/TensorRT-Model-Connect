...
try:
    deepseek_ocr_module = importlib.import_module(
        "tensorrt_model_connect.models.deepseek_ocr.model")
    from tensorrt_model_connect.checkpoint_mapper import WeightDict
    from tensorrt_model_connect import trt_compat
    from tensorrt_model_connect.models.deepseek_ocr import graph_ops, tp_builder
    from tensorrt_model_connect.models.deepseek_ocr.prefill_config import (
