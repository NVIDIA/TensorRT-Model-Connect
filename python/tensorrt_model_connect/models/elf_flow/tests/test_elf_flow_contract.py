...
from tensorrt_model_connect.models.elf_flow.tests.e2e_plugins.runners import diffusion_text_generation


REPO_ROOT = Path(__file__).resolve().parents[5]
ELF_MODEL_DIR = (
    REPO_ROOT / "python" / "tensorrt_model_connect" / "models" / "elf_flow" / "tests"
)
