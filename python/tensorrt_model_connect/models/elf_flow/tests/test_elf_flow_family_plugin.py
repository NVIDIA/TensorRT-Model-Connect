...
try:
    ...
    from tensorrt_model_connect.models.elf_flow import model as plugin
    from tensorrt_model_connect.models.elf_flow.config import (
        make_elf_rope_cache,
        resolve_elf_config,
    )
...
def test_orbax_checkpoint_loader_selects_ema_params(
    ...
    module = importlib.import_module(
        "tensorrt_model_connect.models.elf_flow.model")
...
def test_build_extra_engines_compiles_official_jax_t5_encoder(
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.elf_flow.t5_encoder_builder",
        fake_t5_builder,
    )
...
def test_elf_trt_forward_matches_github_numpy_reference(tmp_path: Path) -> None:
    ...
    from tensorrt_model_connect.models.elf_flow.debug_runner import VisionTrtRunner
    from tensorrt_model_connect.models.elf_flow.builder import build_elf_flow_engine
