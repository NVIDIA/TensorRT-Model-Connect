...
from tensorrt_model_connect.models.gpt_neo.tests._family_plugin_tester import (
    FamilyPluginTester,
)
from tensorrt_model_connect.models.gpt_neo.tests._family_plugin_test_mixin import (
...
class GPTNeoPluginTester(FamilyPluginTester):
    ...
    plugin_module = "tensorrt_model_connect.models.gpt_neo.model"
    model_type = "gpt_neo"
