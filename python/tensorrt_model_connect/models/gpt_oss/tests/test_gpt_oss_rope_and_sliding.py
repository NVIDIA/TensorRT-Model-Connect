...
try:
    ...
    import tensorrt_model_connect.models.gpt_oss.model as gpt_oss
    from tensorrt_model_connect.models.gpt_oss import graph_ops
    from tensorrt_model_connect.models.gpt_oss.config import ModelConfig
    from tensorrt_model_connect.models.gpt_oss.utils import (
...
def _tiny_gpt_oss_weights(config: ModelConfig, seed: int = 7):
    from tensorrt_model_connect.models.gpt_oss.checkpoint_mapper import WeightDict
...
def test_sliding_layers_restrict_attention_to_window():
    ...
    _require_cuda()
    from tensorrt_model_connect.models.gpt_oss.debug_runner import TrtRunner
