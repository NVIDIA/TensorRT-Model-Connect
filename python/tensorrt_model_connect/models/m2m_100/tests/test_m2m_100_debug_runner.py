...
def test_m2m_100_seq2seq_engine_section_and_communicator_forwarded(tmp_path) -> None:
    from tensorrt_model_connect.models.m2m_100.debug_runner import (
    ...
    path = tmp_path / "m2m_100_seq2seq_tp_dispatch.bundle"
    path.write_bytes(bundle)

    communicator = object()
    with patch(
        "tensorrt_model_connect.models.m2m_100.debug_runner.Seq2SeqTrtRunner",
