...
// M2m100InferenceState: unified interface for autoregressive inference state.
//
...
//
// Implementations:
//   M2m100KvCache          — dense append-only (current default)
//   Family-owned recurrent state — recurrent tensor state
//   Family-owned hybrid state — M2m100KvCache + family-owned recurrent state composed
...
class M2m100InferenceState {
  public:
    virtual ~M2m100InferenceState() = default;
    ...
    // M2m100KvCache -> true. Family-owned recurrent state -> false.
