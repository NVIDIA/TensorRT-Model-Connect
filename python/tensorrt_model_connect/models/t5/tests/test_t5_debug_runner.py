...
from tensorrt_model_connect.models.t5.tests._debug_runner_test_support import (
    make_bundle_bytes,
)


def test_t5_text_to_text_engine_section_and_communicator_forwarded(tmp_path) -> None:
    from tensorrt_model_connect.models.t5.debug_runner import (
    ...
    communicator = object()
    with patch(
        "tensorrt_model_connect.models.t5.debug_runner.Seq2SeqTrtRunner",
