...
from tensorrt_model_connect.models.sam.tests.e2e_plugins.comparators.segmentation import (
    PromptedSegmentationComparator,
)
from tensorrt_model_connect.models.sam.tests.e2e_plugins.contract import SamSegmentationPlugin
...
def test_model_plugins_register_model_owned_contract() -> None:
    ...
    try:
        ...
        assert type(plugin).__module__.startswith("tensorrt_model_connect.models.sam.tests.e2e_plugins.")
    finally:
        reset_e2e_registry()
