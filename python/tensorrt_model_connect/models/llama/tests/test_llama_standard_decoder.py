...
class TestTensorNamingContract:
    ...
    def _build_engine(self, **kwargs):
        ...
        from tensorrt_model_connect.models.llama.standard_decoder_builder import build_standard_decoder_engine
    ...
    def test_bf16_embed_input_keeps_external_features_fp32(self):
        ...
        import tensorrt as trt
        from tensorrt_model_connect.config import ModelConfig
        from tensorrt_model_connect.models.llama.standard_decoder_builder import (
