...
std::string llama_detect_chat_template_format(const std::string& jinja_template) {
...
std::string llama_apply_chat_template(const std::string& format, const std::string& prompt,
