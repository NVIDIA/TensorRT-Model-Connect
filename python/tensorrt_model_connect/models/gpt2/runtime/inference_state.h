...
// Gpt2InferenceState: unified interface for autoregressive inference state.
//
...
//
// Implementations:
//   Gpt2KvCache          — dense append-only (current default)
//   Family-owned recurrent state — recurrent tensor state
//   Family-owned hybrid state — Gpt2KvCache + family-owned recurrent state composed
...
class Gpt2InferenceState {
  public:
    virtual ~Gpt2InferenceState() = default;
    ...
    // Gpt2KvCache -> true. Family-owned recurrent state -> false.
