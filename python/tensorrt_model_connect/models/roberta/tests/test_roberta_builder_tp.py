...
from tensorrt_model_connect.models.roberta import model as RobertaModel
from tensorrt_model_connect.parallel_config import ParallelConfig

roberta_plugin = importlib.import_module(
    "tensorrt_model_connect.models.roberta.model")
...
def _roberta_tp_builder_module():
    return pytest.importorskip(
        "tensorrt_model_connect.models.roberta.tp_builder",
...
def test_roberta_plugin_routes_tp_build(monkeypatch):
    ...
    plan = RobertaModel.build_engine(
        _make_config(),
        _make_encoder_weights(),
        max_cache_length=8,
