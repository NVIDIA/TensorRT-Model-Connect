...
from tensorrt_model_connect.models.qwen.build_routing import (
...
from tensorrt_model_connect.models.qwen.native_kv_contract import (
...
def test_plugin_builds_the_requested_split_role_directly(monkeypatch):
    ...
    plugin_module = importlib.import_module(
        "tensorrt_model_connect.models.qwen.model"
    )
