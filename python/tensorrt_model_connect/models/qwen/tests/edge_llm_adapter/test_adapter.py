...
CAPSULE_ROOT = (
    REPOSITORY_ROOT / "python" / "tensorrt_model_connect" / "models" / "qwen" / "edge_llm_adapter"
)
RUNTIME_ROOT = CAPSULE_ROOT.parent / "runtime" / "edge_llm_adapter"
...
def test_imported_package_discovers_edge_llm_only_from_qwen_builder() -> None:
    qwen_spec = importlib.util.find_spec("tensorrt_model_connect.models.qwen")
...
def test_installed_layout_compiles_the_packaged_qwen_runtime(
    ...
    packaged_builder = package / "models" / "qwen" / "edge_llm_adapter"
