...
class TestWhisperTrtRunnerCleanup:
    ...
    def test_del_frees_all_buffers(self):
        from tensorrt_model_connect.models.whisper.debug_runner import WhisperTrtRunner
        ...
        with patch("tensorrt_model_connect.models.whisper.debug_runner.cudart", mock_cudart):
            runner.__del__()
