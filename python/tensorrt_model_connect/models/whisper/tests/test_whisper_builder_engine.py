...
def _whisper_tp_builder_module():
    return pytest.importorskip(
        "tensorrt_model_connect.models.whisper.decoder_tp_builder",
...
def test_whisper_encoder_selector_routes_precision(
    ...
    plugin_module = pytest.importorskip("tensorrt_model_connect.models.whisper.model")
    observed = {}
...
class WhisperPluginTester(FamilyPluginTester):
    ...
    plugin_module = "tensorrt_model_connect.models.whisper.model"
    model_type = "whisper"
    spec = TinyModelSpec(
        vocab_size=_VOCAB,
        hidden_size=_HIDDEN,
