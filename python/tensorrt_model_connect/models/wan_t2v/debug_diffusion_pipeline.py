...
def step3_t5_and_text_proj(bundle_path: str, pp: dict, atol: float) -> bool:
    ...
    from tensorrt_model_connect.models.wan_t2v.diffusion_runner import DiffusionRunner
...
def step8_scheduler_sigmas(bundle_path: str, atol: float) -> bool:
    ...
    num_steps = 30
    from tensorrt_model_connect.models.wan_t2v.schedulers.flow_match_euler import FlowMatchEulerScheduler
