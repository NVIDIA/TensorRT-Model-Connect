...
from tensorrt_model_connect.models.qwen_vl.tests.e2e_plugins.runners.vl_debug_runner import VLTrtRunner
...
try:
    ...
    import tempfile
    from pathlib import Path
    from tensorrt_model_connect.models.qwen_vl.tests.e2e_plugins.runners.vl_debug_runner import load_section_from_bundle
