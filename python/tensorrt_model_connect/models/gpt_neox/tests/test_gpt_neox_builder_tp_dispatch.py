...
"""Family-owned tensor-parallel dispatch tests for gpt_neox."""
...
def test_gpt_neox_plugin_routes_parallel_builds(monkeypatch) -> None:
    module = importlib.import_module("tensorrt_model_connect.models.gpt_neox.model")
...
def test_gpt_neox_tp_builder_keeps_fixed_gelu_fc_mlp() -> None:
    module = importlib.import_module(
        "tensorrt_model_connect.models.gpt_neox.default_dual_profile_decoder_tp"
    )
    ...
    assert "add_activation" in source and "'gelu'" in source
