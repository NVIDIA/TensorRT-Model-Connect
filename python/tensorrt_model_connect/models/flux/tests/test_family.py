...
try:
    ...
    from tensorrt_model_connect.models.flux import model as flux_mod
...
def test_mistral_hidden_state_indices_map_to_preceding_decoder_layers() -> None:
    from tensorrt_model_connect.models.flux.mistral_encoder_builder import (
...
def test_build_components_with_clip_and_second_t5(
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.flux.t5_encoder_builder",
        _module(
            "tensorrt_model_connect.models.flux.t5_encoder_builder",
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.flux.clip_encoder_builder",
        _module(
            "tensorrt_model_connect.models.flux.clip_encoder_builder",
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.flux.flux_dit_builder",
        _module(
            "tensorrt_model_connect.models.flux.flux_dit_builder",
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.flux.flux_dit_tp_builder",
        _module(
            "tensorrt_model_connect.models.flux.flux_dit_tp_builder",
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.flux.flux_vae_builder",
        _module(
            "tensorrt_model_connect.models.flux.flux_vae_builder",
...
def test_build_flux2_components_forwards_precision_to_mistral(
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.flux.mistral_encoder_builder",
        _module(
            "tensorrt_model_connect.models.flux.mistral_encoder_builder",
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.flux.flux2_dit_builder",
        _module(
            "tensorrt_model_connect.models.flux.flux2_dit_builder",
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.flux.flux2_dit_tp_builder",
        _module(
            "tensorrt_model_connect.models.flux.flux2_dit_tp_builder",
...
def test_flux2_mha_forwards_fp8_attention_scales(
    ...
    sys.modules.pop("tensorrt_model_connect.models.flux.flux2_dit_builder", None)
    ...
    import tensorrt_model_connect.models.flux.flux2_dit_builder as flux2_builder
