...
from tensorrt_model_connect.models.convbert import model as ConvBertModel
from tensorrt_model_connect.parallel_config import ParallelConfig

convbert_plugin = importlib.import_module(
    "tensorrt_model_connect.models.convbert.model")
...
def _convbert_tp_builder_module():
    return pytest.importorskip(
        "tensorrt_model_connect.models.convbert.tp_builder",
