...
// Olmo2InferenceState: unified interface for autoregressive inference state.
//
...
//
// Implementations:
//   Olmo2KvCache          — dense append-only (current default)
//   Family-owned recurrent state — recurrent tensor state
//   Family-owned hybrid state — Olmo2KvCache + family-owned recurrent state composed
...
class Olmo2InferenceState {
  public:
    virtual ~Olmo2InferenceState() = default;
    ...
    // Olmo2KvCache -> true. Family-owned recurrent state -> false.
