...
// Olmo2ISampler: token selection abstraction for autoregressive generation.
//
...
//
// Olmo2LogitsLocation tells the pipeline whether to D2H transfer logits before
...
/// olmo2-owned sampler interface.
class Olmo2ISampler {
  public:
    virtual ~Olmo2ISampler() = default;
    ...
    virtual Olmo2SampleResult sample(const float* logits, int32_t vocab_size,
                                     const Olmo2SamplingParams& params) = 0;
    ...
    virtual Olmo2LogitsLocation logits_location() const = 0;
...
/// Build Olmo2SamplingParams from GenerateConfig fields.
...
/// Factory: create sampler from Olmo2SamplingParams.
...
std::unique_ptr<Olmo2ISampler> create_olmo2_sampler(const Olmo2SamplingParams& params,
                                                    const Olmo2SamplerFactoryOptions& options);
