...
from tensorrt_model_connect.models.nemotron.tests._family_plugin_tester import (
    FamilyPluginTester,
)
from tensorrt_model_connect.models.nemotron.tests._family_plugin_test_mixin import (
...
class NemotronPluginTester(FamilyPluginTester):
    ...
    plugin_module = "tensorrt_model_connect.models.nemotron.model"
    model_type = "nemotron"
