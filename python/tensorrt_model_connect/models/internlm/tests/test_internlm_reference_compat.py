...
from tensorrt_model_connect.models.internlm.tests.e2e_plugins.references import hf_transformers
...
def test_reference_uses_independently_pinned_fast_tokenizer() -> None:
    ...
    assert "models.internlm.tokenizer_json" not in module_source
...
def test_reference_resolver_is_independent_and_fail_closed(
    ...
    production_tokenizer = importlib.import_module(
        "tensorrt_model_connect.models.internlm.tokenizer_json"
    )
