...
from tensorrt_model_connect.models.mixtral.tests._family_plugin_tester import (
    FamilyPluginTester,
)
from tensorrt_model_connect.models.mixtral.tests._family_plugin_test_mixin import (
...
class MixtralPluginTester(FamilyPluginTester):
    ...
    plugin_module = "tensorrt_model_connect.models.mixtral.model"
    model_type = "mixtral"
