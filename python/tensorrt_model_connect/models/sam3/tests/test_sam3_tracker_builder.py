...
from tensorrt_model_connect.models.sam3 import tracker_builder, tracker_weights
...
def test_sam3_tracker_init_uses_meta_mask_input_geometry() -> None:
    from tensorrt_model_connect.models.sam3 import tracker_decoder_builder
...
def test_sam3_production_build_path_has_no_aoti_or_bridge_modules() -> None:
    ...
    runtime_dir = repository_root / "python/tensorrt_model_connect/models/sam3/runtime"
...
def test_sam3_runtime_loads_required_step_plans_without_external_bridge() -> None:
    repository_root = Path(__file__).resolve().parents[5]
    plugin_path = repository_root / "python/tensorrt_model_connect/models/sam3/runtime/plugin.cpp"
