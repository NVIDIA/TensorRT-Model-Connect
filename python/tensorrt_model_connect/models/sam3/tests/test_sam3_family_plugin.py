...
def test_sam3_matches_sam3_video_not_legacy_sam() -> None:
    ...
    from tensorrt_model_connect.models.sam3 import model
...
def test_sam3_load_weights_fails_before_engine_build_for_incomplete_tokenizer(
    ...
    from tensorrt_model_connect.models.sam3 import model as plugin
...
def test_sam3_build_engine_delegates_to_text_encoder_builder(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.sam3.text_encoder_builder",
        fake_module,
    )
...
def test_sam3_build_vision_engine_delegates_to_vision_builder(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.sam3.vision_encoder_builder",
        fake_module,
    )
...
def test_sam3_build_extra_engines_delegates_to_core_builder(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.sam3.core_builder",
        fake_module,
    )
...
def test_sam3_video_build_packages_all_tracker_plans(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.sam3.tracker_builder",
        fake_tracker,
    )
