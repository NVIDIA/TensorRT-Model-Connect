...
if __package__ in {None, ""}:
    ...
    _SAM3_PYTHON_ROOT = _REPOSITORY_ROOT / "python" / "tensorrt_model_connect" / "models" / "sam3"
    sys.path.insert(0, str(_SAM3_PYTHON_ROOT))
    _TOKENIZER_CONTRACT_MODULE = "tokenizer_contract"
else:
    _TOKENIZER_CONTRACT_MODULE = "tensorrt_model_connect.models.sam3.tokenizer_contract"
