...
from tensorrt_model_connect.models.sam3 import model as sam3_model
...
def _source_snapshot() -> tuple[Path, dict[str, object]]:
    ...
    sam3_source = repo_root / "python" / "tensorrt_model_connect" / "models" / "sam3"
...
def main() -> None:
    ...
    if args.engine == "vision-encoder":
        ...
        from tensorrt_model_connect.models.sam3 import (
            core_builder,
    ...
    try:
        if args.engine == "vision-encoder":
            ...
            from tensorrt_model_connect.models.sam3.model import (
