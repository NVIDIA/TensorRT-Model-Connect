...
from tensorrt_model_connect.models.stablelm.tests._family_plugin_test_support import (
    ModelConfig,
    _rand,
    _write_config,
    _write_safetensors,
...
class TestStablelmPlugin:
    ...
    def test_load_weights_keys(self, tmp_path):
        from tensorrt_model_connect.models.stablelm import model as plugin
