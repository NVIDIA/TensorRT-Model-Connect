...
from tensorrt_model_connect.models.starcoder2.tests._family_plugin_test_support import (
    ModelConfig,
    _rand,
    _write_config,
    _write_safetensors,
...
class TestStarcoder2Plugin:
    ...
    def test_load_weights_keys(self, tmp_path):
        from tensorrt_model_connect.models.starcoder2 import model as plugin
