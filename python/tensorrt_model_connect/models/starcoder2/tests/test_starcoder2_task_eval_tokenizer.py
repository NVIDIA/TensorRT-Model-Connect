...
from tensorrt_model_connect.models.starcoder2.tools.validation import (
    transform_bundle_tokenizer,
)
from tools.validation.engine import _load_text_input_contract
...
def test_gpt2_wrapper_uses_effective_byte_level_contract() -> None:
    ...
    effective = transform_bundle_tokenizer(
        source,
        {
...
def test_input_contract_loads_effective_bundled_wrapper(
    ...
    loaded_hf, bundled, config = _load_text_input_contract(
        model={"family": "starcoder2", "hf_id": "bigcode/starcoder2-3b"},
        bundle_path=bundle,
