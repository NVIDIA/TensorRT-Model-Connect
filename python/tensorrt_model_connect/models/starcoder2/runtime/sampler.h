...
// Starcoder2ISampler: token selection abstraction for autoregressive generation.
//
...
//
// Starcoder2LogitsLocation tells the pipeline whether to D2H transfer logits before
...
class Starcoder2ISampler {
  public:
    ...
    virtual Starcoder2LogitsLocation logits_location() const = 0;
...
/// Build Starcoder2SamplingParams from GenerateConfig fields.
...
/// Factory: create sampler from Starcoder2SamplingParams.
...
std::unique_ptr<Starcoder2ISampler>
create_starcoder2_sampler(const Starcoder2SamplingParams& params,
                          const Starcoder2SamplerFactoryOptions& options);
