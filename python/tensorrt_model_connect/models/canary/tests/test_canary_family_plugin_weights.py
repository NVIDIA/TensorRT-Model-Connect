...
class TestCanaryPlugin:
    ...
    def test_audio_config_preserves_nemo_frontend_contract(self):
        plugin = importlib.import_module(
            "tensorrt_model_connect.models.canary.model")
    ...
    def _tp_builder_module():
        return pytest.importorskip(
            "tensorrt_model_connect.models.canary.decoder_tp_builder",
    ...
    def test_load_weights_keys(self, tmp_path):
        ...
        from tensorrt_model_connect.models.canary import model as plugin
