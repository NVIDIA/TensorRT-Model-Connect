...
from tensorrt_model_connect.models.distilbert import model as DistilBertModel
from tensorrt_model_connect.parallel_config import ParallelConfig

distilbert_plugin = importlib.import_module(
    "tensorrt_model_connect.models.distilbert.model")
...
def _distilbert_tp_builder_module():
    return pytest.importorskip(
        "tensorrt_model_connect.models.distilbert.tp_builder",
...
def test_distilbert_plugin_routes_tp_build(monkeypatch):
    ...
    plan = DistilBertModel.build_engine(
        _make_config(),
        _make_encoder_weights(),
        max_cache_length=8,
