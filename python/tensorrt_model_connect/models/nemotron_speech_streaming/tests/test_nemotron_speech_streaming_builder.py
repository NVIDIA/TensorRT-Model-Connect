...
from tensorrt_model_connect.models.nemotron_speech_streaming.tests.synthetic_nemo import (
    make_nemo_archive,
...
class TestNemotronSpeechStreamingPlugin:
    ...
    def test_load_weights_keys(self, tmp_path):
        ...
        from tensorrt_model_connect.models.nemotron_speech_streaming import model as plugin
