...
from tensorrt_model_connect.models.nemotron_speech_streaming.predictor_tp_builder import (
    _slice_lstm_gate_columns,
    _validate_predictor_tp,
)

nss = importlib.import_module("tensorrt_model_connect.models.nemotron_speech_streaming.model")
