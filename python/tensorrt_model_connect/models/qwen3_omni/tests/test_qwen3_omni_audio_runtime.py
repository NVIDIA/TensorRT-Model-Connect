...
from tensorrt_model_connect.models.qwen3_omni.audio_runtime import (
    TalkerRequest,
    _WORKER_ERROR,
    _WORKER_MAGIC,
    _WORKER_OK,
...
from tensorrt_model_connect.models.qwen3_omni import model as Qwen3OmniModel
from tensorrt_model_connect.models.qwen3_omni.model import (
...
def test_thinker_load_weights_preserves_bf16_storage(monkeypatch, tmp_path) -> None:
    plugin_module = importlib.import_module(
        "tensorrt_model_connect.models.qwen3_omni.model")
