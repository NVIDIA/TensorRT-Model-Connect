...
from tensorrt_model_connect.models.qwen3_omni.tests import official_hf_audio
from tensorrt_model_connect.models.qwen3_omni.tests.e2e_plugins.references import torch_reference
