...
from tensorrt_model_connect.models.dinov3.tests.e2e_plugins import report
    ...
    *,
    ...
    return {
        ...
        "case_config": {
            ...
            "inputs": {"image": "python/tensorrt_model_connect/models/dinov3/tests/data/test_img.jpeg"},
        },
        "stage_outputs": {
