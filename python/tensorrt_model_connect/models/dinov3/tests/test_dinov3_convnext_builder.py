...
def _load_builder(monkeypatch: pytest.MonkeyPatch):
    ...
    return importlib.import_module("tensorrt_model_connect.models.dinov3.convnext_builder")


@pytest.mark.parametrize("precision", ["fp32", "fp16"])
def test_real_tensorrt_build_marks_hf_outputs(precision: str) -> None:
    trt = pytest.importorskip("tensorrt")
    from tensorrt_model_connect.models.dinov3.convnext_builder import (
...
def test_family_load_repairs_generic_bundle_info_fields(tmp_path) -> None:
    ...
    from tensorrt_model_connect.models.dinov3.config import ModelConfig
    import tensorrt_model_connect.models.dinov3.model as plugin
