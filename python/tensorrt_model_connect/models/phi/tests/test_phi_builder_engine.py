...
from tensorrt_model_connect.models.phi.tests._family_plugin_tester import (
    FamilyPluginTester,
)
from tensorrt_model_connect.models.phi.tests._family_plugin_test_mixin import (
    FamilyPluginTestMixin,
)


class PhiPluginTester(FamilyPluginTester):
    plugin_module = "tensorrt_model_connect.models.phi.model"
    model_type = "phi3"
