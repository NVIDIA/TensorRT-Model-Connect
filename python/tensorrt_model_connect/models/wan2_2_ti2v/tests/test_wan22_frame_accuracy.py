...
from tensorrt_model_connect.models.wan2_2_ti2v.tests.e2e_plugins.comparators import frame_accuracy
from tensorrt_model_connect.models.wan2_2_ti2v.tests.e2e_plugins.comparators.diffusion import (
    DiffusionComparator,
)
