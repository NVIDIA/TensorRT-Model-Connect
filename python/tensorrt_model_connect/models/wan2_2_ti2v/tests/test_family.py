...
from tensorrt_model_connect.models.wan2_2_ti2v import fp8_profile
from tensorrt_model_connect.models.wan2_2_ti2v import model as Wan22TI2VModel
from tensorrt_model_connect.models.wan2_2_ti2v.model import (
...
def test_public_builder_routes_wan_to_component_bundle(
    ...
    from tensorrt_model_connect.models.wan2_2_ti2v import model
...
def test_component_builder_emits_four_native_plans(
    ...
    from tensorrt_model_connect.models.wan2_2_ti2v import trt_builder
...
def test_runtime_fp_contract_compile_option_is_model_manifest_owned() -> None:
    ...
    pipeline_source = (
        repo_root
        / "python/tensorrt_model_connect/models/wan2_2_ti2v/runtime/pipeline.cpp"
    ).read_text()
