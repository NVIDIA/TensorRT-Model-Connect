...
from tensorrt_model_connect.models.wan2_2_ti2v.tests.e2e_plugins import reference as reference_plugins
from tensorrt_model_connect.models.wan2_2_ti2v.tests.e2e_plugins.references import (
...
def test_only_nightly_selects_the_external_official_wan_reference() -> None:
    ...
    assert full.hf_revision == wan22_official.HF_REFERENCE_REVISION
    assert l0.hf_revision == wan22_official.HF_REFERENCE_REVISION
    ...
    assert full.metadata["build_cli_args"] == expected_build_args
    assert l0.metadata["build_cli_args"] == expected_build_args
...
def test_cached_reference_uses_the_raw_selective_offline_snapshot_contract(
    ...
    assert wan22_official._snapshot_revision(resolved) == wan22_official.HF_REFERENCE_REVISION
