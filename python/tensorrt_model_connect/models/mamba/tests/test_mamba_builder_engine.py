...
from tensorrt_model_connect.models.mamba.tests._family_plugin_tester import (
    FamilyPluginTester,
    TinyModelSpec,
)
from tensorrt_model_connect.models.mamba.tests._family_plugin_test_mixin import (
...
class MambaPluginTester(FamilyPluginTester):
    ...
    plugin_module = "tensorrt_model_connect.models.mamba.model"
    model_type = "mamba"
    spec = TinyModelSpec(
        vocab_size=32,
        hidden_size=16,
