...
from tensorrt_model_connect.models.lance.tests.e2e_plugins.references.lance_image_attention_compat.flash_attn import (
...
def test_fallback_exposes_transformers_flash_attention_import_surface() -> None:
    package = (
        "tensorrt_model_connect.models.lance.tests.e2e_plugins.references."
