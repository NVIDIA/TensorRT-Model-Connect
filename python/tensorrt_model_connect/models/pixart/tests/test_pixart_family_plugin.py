...
try:
    ...
    from tensorrt_model_connect.models.pixart import model as pixart_mod
...
def test_build_components_uses_transformer_and_t5_configs(
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.pixart.t5_encoder_builder",
        _module(
            "tensorrt_model_connect.models.pixart.t5_encoder_builder",
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.pixart.standard_dit_builder",
        _module(
            "tensorrt_model_connect.models.pixart.standard_dit_builder",
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.pixart.vae_2d_builder",
        _module(
            "tensorrt_model_connect.models.pixart.vae_2d_builder",
...
def test_build_components_tensor_parallel_uses_tp_dit_builder(
    ...
    monkeypatch.setitem(
        sys.modules,
        "tensorrt_model_connect.models.pixart.standard_dit_tp_builder",
        _module(
            "tensorrt_model_connect.models.pixart.standard_dit_tp_builder",
...
def test_load_pixart_dit_weights_maps_optional_biases(
    ...
    cm = importlib.import_module("tensorrt_model_connect.models.pixart.checkpoint_mapper")
