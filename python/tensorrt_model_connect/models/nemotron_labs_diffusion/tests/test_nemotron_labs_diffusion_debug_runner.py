...
"""Nemotron Labs Diffusion-owned debug runner dispatch tests."""
...
def test_nemotron_labs_diffusion_dispatch_uses_owned_runner(tmp_path):
    from tensorrt_model_connect.models.nemotron_labs_diffusion.debug_runner import (
    ...
    bundle = _make_bundle_bytes(
        ...
        extra_sections={
            ...
            "engine_plan_tp_rank1": b"NLD_RANK1_ENGINE",
        },
    )
    ...
    communicator = object()
    with patch(
        "tensorrt_model_connect.models.nemotron_labs_diffusion.debug_runner.TrtRunner",
    ...
    assert runner == "nemotron-labs-diffusion-tp-runner"
    kwargs = mock_runner.call_args.kwargs
    assert kwargs["engine_plan"] == b"NLD_RANK1_ENGINE"
