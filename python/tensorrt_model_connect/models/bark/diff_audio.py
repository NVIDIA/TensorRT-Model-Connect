...
def stage4_greedy_parity(args) -> bool:
    ...
    try:
        ...
        from tensorrt_model_connect.models.bark.config import ModelConfig
        from tensorrt_model_connect.models.bark import model as bark_model
        from tensorrt_model_connect.models.bark.debug_runner import (
            TrtRunner,
            VisionTrtRunner,
        )
