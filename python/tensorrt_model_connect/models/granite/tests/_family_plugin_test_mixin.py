...
"""Owner-local test mixin providing auto-tests for family plugin engine tests.
...
Usage within this owner:
    from ._family_plugin_tester import FamilyPluginTester
    from ._family_plugin_test_mixin import FamilyPluginTestMixin
