...
from tensorrt_model_connect.models.mpnet import model as MpnetModel
from tensorrt_model_connect.parallel_config import ParallelConfig

mpnet_plugin = importlib.import_module(
    "tensorrt_model_connect.models.mpnet.model")
...
def _mpnet_tp_builder_module():
    return pytest.importorskip(
        "tensorrt_model_connect.models.mpnet.tp_builder",
