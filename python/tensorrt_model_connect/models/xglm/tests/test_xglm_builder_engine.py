...
from tensorrt_model_connect.models.xglm.tests._family_plugin_tester import (
    FamilyPluginTester,
)
from tensorrt_model_connect.models.xglm.tests._family_plugin_test_mixin import (
...
class XGLMPluginTester(FamilyPluginTester):
    ...
    plugin_module = "tensorrt_model_connect.models.xglm.model"
    model_type = "xglm"
