...
from tensorrt_model_connect.models.sam2.checkpoint_mapper import (
    Checkpoint,
    CheckpointError,
    PUBLIC_CHECKPOINT_SHA256,
    PublicCoreCheckpoint,
)
from tensorrt_model_connect.models.sam2.float_math import reciprocal_sqrtf
from tensorrt_model_connect.models.sam2.model_config import (
...
def test_family_loads_only_authenticated_checkpoint_bytes(
    ...
    from tensorrt_model_connect.models.sam2 import checkpoint_mapper
...
def test_family_maps_the_six_python_plans(monkeypatch: pytest.MonkeyPatch) -> None:
    plugin = family_model
    module = importlib.import_module("tensorrt_model_connect.models.sam2.model")
    sections = []
...
def test_builder_implementation_is_family_owned_python() -> None:
    ...
    family = repository / "python/tensorrt_model_connect/models/sam2"
    ...
    assert not (repository / "src/cmake/native.cmake").exists()
