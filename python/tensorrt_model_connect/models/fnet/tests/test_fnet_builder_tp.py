...
from tensorrt_model_connect.models.fnet import model as FNetModel
from tensorrt_model_connect.parallel_config import ParallelConfig

fnet_plugin = importlib.import_module(
    "tensorrt_model_connect.models.fnet.model")
...
def _fnet_tp_builder_module():
    return pytest.importorskip(
        "tensorrt_model_connect.models.fnet.tp_builder",
