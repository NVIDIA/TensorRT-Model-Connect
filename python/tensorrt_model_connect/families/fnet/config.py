...
"""FNet family model configuration."""
...
@dataclass
class ModelConfig:
    """Fields consumed by the FNet encoder and tensor-parallel builders."""
    ...
    def from_json(text: str) -> ModelConfig:
        ...
        return ModelConfig(
            model_type=data.get("model_type", "fnet") or "fnet",
            ...
            hidden_act=data.get("hidden_act", "gelu_new") or "gelu_new",
            _head_dim=int(data.get("head_dim", 0)),
            raw=data,
        )

    @classmethod
    def create_tiny(cls, model_type: str = "fnet", **overrides) -> ModelConfig:
        data = {
