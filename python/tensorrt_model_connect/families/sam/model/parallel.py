...
def build_sam_tp_encoder_engine(
    ...
    *,
    ...
    pos_c = graph_ops.add_constant(network, (1, grid_size, grid_size, hidden), pos_embed)
    ...
    for layer_idx in range(num_layers):
        ...
        normed = graph_ops.add_layer_norm(
            network, reshape_2d.get_output(0), hidden, norm1_w, norm1_b, eps_t
        )

        normed_4d = network.add_shuffle(normed)
        normed_4d.reshape_dims = (1, grid_size, grid_size, hidden)

        attn_out_4d = SamPlugin._build_attention_2d(
            network,
        ...
        normed2 = graph_ops.add_layer_norm(
            network, res1_2d.get_output(0), hidden, norm2_w, norm2_b, eps_t
        )
        ...
        fc1 = graph_ops.add_matmul_rhs_constant(network, normed2, hidden, local_mlp_dim, fc1_w)
        ...
        fc2 = graph_ops.add_matmul_rhs_constant(network, gelu, local_mlp_dim, hidden, fc2_w)
