...
class SamPlugin:
    ...
    def build_vision_engine(
        ...
        *,
        ...
        image_pe_flat_c = graph_ops.add_constant(network, (img_seq, decoder_hidden), image_pe_flat)
        ...
        img_plus_dense = network.add_elementwise(
            image_embeddings_in, no_mask_c, trt.ElementWiseOperation.SUM
        ).get_output(0)
    ...
    def _build_global_attention(
        ...
        return SamPlugin._build_windowed_attention(
            network, inp_4d, weights, w_prefix, grid_size, hidden, num_heads, head_dim, 0
        )
