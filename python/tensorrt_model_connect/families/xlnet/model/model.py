...
def build_xlnet_engine(
    ...
    *,
    ...
    pos_emb_const = add_constant(network, pos_emb_np.shape, pos_emb_np, dtype=work_np_dtype)
...
def _add_xlnet_layer(
    *,
    ...
    seg_embed = add_constant(
        network,
        (2, num_heads, d_head),
        weights[f"{prefix}.seg_embed"],
        dtype=dtype,
    )
