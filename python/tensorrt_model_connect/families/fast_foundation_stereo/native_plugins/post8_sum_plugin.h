...
class FastFoundationStereoPost8SumPlugin final : public nvinfer1::IPluginV3,
  ...
  public:
    ...
    static constexpr int32_t kDefaultTilePositions = 32;

  private:
    bool parseFields(nvinfer1::PluginFieldCollection const& fields) noexcept;
    void refreshSerializationField() noexcept;

    int32_t tile_positions_{0};
