...
class FastFoundationStereoGwcPlugin final : public nvinfer1::IPluginV2DynamicExt {
  public:
    FastFoundationStereoGwcPlugin() = default;
    FastFoundationStereoGwcPlugin(const void* data, std::size_t length);
    ...
    FastFoundationStereoGwcPlugin* clone() const noexcept override;
    ...
    static constexpr const char* kPLUGIN_NAME = "FastFoundationStereoGwc";
