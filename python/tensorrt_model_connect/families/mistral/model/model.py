...
def make_rope_table_half_dim(
    ...
    """Build Mistral's full-head RoPE cos or sin half-dimension table."""
...
def add_apply_rope_native(
    ...
    """Apply Mistral's rotate-half RoPE to row-major attention projections."""
...
def add_attention_core(
    ...
    """Run Mistral's scaled, additive-mask attention."""
...
def add_attention_block(
    ...
    *,
    ...
    """Build Mistral pre-norm attention and the updated KV rows."""
...
def build_standard_decoder_engine(
    ...
    *,
    ...
    """Build a Mistral decoder engine, including debug and split-engine modes."""
    ...
    if verbose:
        print(
            f"[trtmc build] Building Mistral engine ({num_layers} layers, hidden={hidden}, "
...
def build_dual_profile_decoder_engine(
    ...
    *,
    ...
    """Build Mistral's prefill-only or combined prefill/decode engine."""
    ...
    if verbose:
        ...
        print(
            f"[trtmc build] Building {mode_label} Mistral engine "
