...
def reshape_rows_to_heads_4d(
    ...
    """Reshape ALBERT rows from [S, H * D] to [1, H, S, D]."""
...
def add_attention_core(
    ...
    """Add non-causal scaled dot-product attention for ALBERT."""
...
def add_attention_from_rows(
    ...
    *,
    ...
    """Apply ALBERT MHA to row-major [S, H * D] Q/K/V tensors."""
    ...
    ctx_4d = add_attention_core(network, q_4d, k_4d, v_4d, mask)
...
def build_encoder_engine(
    ...
    *,
    ...
    if precision == "fp16":
        ...
        raise ValueError(f"Unsupported ALBERT precision: {precision}")
