...
"""Tensor-parallel ALBERT encoder engine builder.
...
def shard_encoder_weights(
    ...
    *,
    ...
    """Return rank-local ALBERT encoder weights for the TP builder."""
...
def build_tp_encoder_engine(
    ...
    *,
    ...
    """Build a rank-local TRT engine plan for a ALBERT encoder.
    ...
    # ALBERT factorizes its embedding width from the encoder hidden width.
