...
class SigmoidCreator final : public nvinfer1::IPluginCreator {
  public:
    SigmoidCreator() {
        fields_.nbFields = 0;
        fields_.fields = nullptr;
    }
    char const* getPluginName() const noexcept override { return SigmoidPlugin::kPLUGIN_NAME; }
    char const* getPluginVersion() const noexcept override {
        return SigmoidPlugin::kPLUGIN_VERSION;
    }
    ...
    nvinfer1::IPluginV2* deserializePlugin(char const* name, void const* data,
        ...
        (void)name;
        auto* plugin = new SigmoidPlugin(data, length);
        plugin->setPluginNamespace(namespace_.c_str());
        return plugin;
    }
...
static nvinfer1::PluginRegistrar<trtmc::sam2_hoi::SigmoidCreator> pluginRegistrarSam2HoiSigmoid{};
