...
class LayerNorm256Creator final : public nvinfer1::IPluginCreator {
  public:
    LayerNorm256Creator() {
        fields_.nbFields = 0;
        fields_.fields = nullptr;
    }
    char const* getPluginName() const noexcept override { return LayerNorm256Plugin::kPLUGIN_NAME; }
    char const* getPluginVersion() const noexcept override {
        return LayerNorm256Plugin::kPLUGIN_VERSION;
    }
    ...
    createPlugin(char const* name,
        ...
        (void)name;
        (void)fields;
        auto* plugin = new LayerNorm256Plugin();
    ...
    nvinfer1::IPluginV2* deserializePlugin(char const* name, void const* data,
        ...
        (void)name;
        auto* plugin = new LayerNorm256Plugin(data, length);
        plugin->setPluginNamespace(namespace_.c_str());
        return plugin;
    }
...
static nvinfer1::PluginRegistrar<trtmc::sam2_hoi::LayerNorm256Creator>
    pluginRegistrarSam2HoiLayerNorm256{};
