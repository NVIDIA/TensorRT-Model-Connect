...
class HieraLayerNormPlugin final : public nvinfer1::IPluginV2DynamicExt {
  public:
    HieraLayerNormPlugin() = default;
    HieraLayerNormPlugin(const void* data, std::size_t length);
    ...
    HieraLayerNormPlugin* clone() const noexcept override;
    nvinfer1::DimsExprs
    ...
    static constexpr char const* kPLUGIN_NAME = "Sam2HoiHieraLayerNorm";
