...
class HieraFlashAttention96Plugin final : public nvinfer1::IPluginV2DynamicExt {
  public:
    HieraFlashAttention96Plugin() = default;
    HieraFlashAttention96Plugin(const void* data, std::size_t length);
    ...
    HieraFlashAttention96Plugin* clone() const noexcept override;
    nvinfer1::DimsExprs
    ...
    static constexpr char const* kPLUGIN_NAME = "Sam2HoiHieraFlashAttention96";
