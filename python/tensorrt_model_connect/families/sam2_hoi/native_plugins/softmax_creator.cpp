...
class SoftmaxCreator final : public nvinfer1::IPluginCreator {
  public:
    SoftmaxCreator() {
        fields_.nbFields = 0;
        fields_.fields = nullptr;
    }
    char const* getPluginName() const noexcept override { return SoftmaxPlugin::kPLUGIN_NAME; }
    char const* getPluginVersion() const noexcept override {
        return SoftmaxPlugin::kPLUGIN_VERSION;
    }
    ...
    nvinfer1::IPluginV2* deserializePlugin(char const* name, void const* data,
        ...
        (void)name;
        auto* plugin = new SoftmaxPlugin(data, length);
        plugin->setPluginNamespace(namespace_.c_str());
        return plugin;
    }
...
static nvinfer1::PluginRegistrar<trtmc::sam2_hoi::SoftmaxCreator> pluginRegistrarSam2HoiSoftmax{};
