...
class SigmoidPlugin final : public nvinfer1::IPluginV2DynamicExt {
  public:
    SigmoidPlugin() = default;
    SigmoidPlugin(const void* data, std::size_t length);
    ...
    SigmoidPlugin* clone() const noexcept override;
    nvinfer1::DimsExprs
    ...
    static constexpr char const* kPLUGIN_NAME = "Sam2HoiSigmoid";
