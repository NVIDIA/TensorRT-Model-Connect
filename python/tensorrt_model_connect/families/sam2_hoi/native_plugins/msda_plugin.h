...
class MsDeformAttnPlugin final : public nvinfer1::IPluginV2DynamicExt {
  public:
    MsDeformAttnPlugin() = default;
    MsDeformAttnPlugin(const void* data, std::size_t length);
    ...
    MsDeformAttnPlugin* clone() const noexcept override;
    nvinfer1::DimsExprs
    ...
    static constexpr char const* kPLUGIN_NAME = "Sam2HoiMsDeformAttn";
