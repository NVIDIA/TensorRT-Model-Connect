...
class HieraPatchConvCreator final : public nvinfer1::IPluginCreator {
  public:
    HieraPatchConvCreator() {
        fields_.nbFields = 0;
        fields_.fields = nullptr;
    }
    char const* getPluginName() const noexcept override {
        return HieraPatchConvPlugin::kPLUGIN_NAME;
    }
    char const* getPluginVersion() const noexcept override {
        return HieraPatchConvPlugin::kPLUGIN_VERSION;
    }
    ...
    createPlugin(char const* name,
        ...
        (void)name;
        (void)fields;
        auto* plugin = new HieraPatchConvPlugin();
    ...
    nvinfer1::IPluginV2* deserializePlugin(char const* name, void const* data,
        ...
        (void)name;
        auto* plugin = new HieraPatchConvPlugin(data, length);
        plugin->setPluginNamespace(namespace_.c_str());
        return plugin;
    }
...
static nvinfer1::PluginRegistrar<trtmc::sam2_hoi::HieraPatchConvCreator>
    pluginRegistrarSam2HoiHieraPatchConv{};
