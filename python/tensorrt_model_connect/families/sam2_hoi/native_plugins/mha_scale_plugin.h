...
class MhaScalePlugin final : public nvinfer1::IPluginV2DynamicExt {
  public:
    MhaScalePlugin() = default;
    MhaScalePlugin(const void* data, std::size_t length);
    ...
    MhaScalePlugin* clone() const noexcept override;
    nvinfer1::DimsExprs
    ...
    static constexpr char const* kPLUGIN_NAME = "Sam2HoiMhaScale";
