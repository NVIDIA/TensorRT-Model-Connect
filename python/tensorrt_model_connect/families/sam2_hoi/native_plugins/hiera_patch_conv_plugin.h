...
class HieraPatchConvPlugin final : public nvinfer1::IPluginV2DynamicExt {
  public:
    HieraPatchConvPlugin() = default;
    HieraPatchConvPlugin(const void* data, std::size_t length);
    ...
    HieraPatchConvPlugin* clone() const noexcept override;
    nvinfer1::DimsExprs
    ...
    static constexpr char const* kPLUGIN_NAME = "Sam2HoiHieraPatchConv";
