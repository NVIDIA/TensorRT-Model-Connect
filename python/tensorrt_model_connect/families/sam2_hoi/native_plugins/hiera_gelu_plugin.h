...
class HieraGeluErfBf16Plugin final : public nvinfer1::IPluginV2DynamicExt {
  public:
    HieraGeluErfBf16Plugin() = default;
    HieraGeluErfBf16Plugin(const void* data, std::size_t length);
    ...
    HieraGeluErfBf16Plugin* clone() const noexcept override;
    nvinfer1::DimsExprs
    ...
    static constexpr char const* kPLUGIN_NAME = "Sam2HoiHieraGeluErfBF16";
