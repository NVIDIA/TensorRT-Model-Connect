...
class LayerNorm256Plugin final : public nvinfer1::IPluginV2DynamicExt {
  public:
    LayerNorm256Plugin() = default;
    LayerNorm256Plugin(const void* data, std::size_t length);
    ...
    LayerNorm256Plugin* clone() const noexcept override;
    nvinfer1::DimsExprs
    ...
    static constexpr char const* kPLUGIN_NAME = "Sam2HoiLayerNorm256";
