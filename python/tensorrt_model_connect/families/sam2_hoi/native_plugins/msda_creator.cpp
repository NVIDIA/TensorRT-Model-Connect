...
class MsDeformAttnCreator final : public nvinfer1::IPluginCreator {
  public:
    MsDeformAttnCreator() {
        fields_.nbFields = 0;
    ...
    char const* getPluginName() const noexcept override { return MsDeformAttnPlugin::kPLUGIN_NAME; }
    char const* getPluginVersion() const noexcept override {
        return MsDeformAttnPlugin::kPLUGIN_VERSION;
    }
    ...
    createPlugin(char const* name,
        ...
        (void)name;
        (void)fields;
        auto* plugin = new MsDeformAttnPlugin();
    ...
    nvinfer1::IPluginV2* deserializePlugin(char const* name, void const* data,
        ...
        (void)name;
        auto* plugin = new MsDeformAttnPlugin(data, length);
        plugin->setPluginNamespace(namespace_.c_str());
        return plugin;
    }
...
static nvinfer1::PluginRegistrar<trtmc::sam2_hoi::MsDeformAttnCreator>
    pluginRegistrarSam2HoiMsDeformAttn{};
