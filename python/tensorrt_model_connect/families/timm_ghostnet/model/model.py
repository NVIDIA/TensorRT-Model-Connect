...
"""TensorRT graph builders for timm GhostNet classifiers.

A Ghost module produces half its channels with a pointwise convolution and the
other half with a cheap depthwise convolution, then concatenates the two. That
needs channel concatenation on top of the plain convolutional set, plus the
hard-sigmoid squeeze-excite gate GhostNet shares with MobileNetV3.
"""
...
def add_squeeze_excite(
    ...
    *,
    ...
    """Squeeze-and-excite gate with a ReLU inner activation and hard-sigmoid gate."""
