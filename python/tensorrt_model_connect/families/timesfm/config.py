...
"""TimesFM family model configuration."""
...
@dataclass
class ModelConfig:
    """Fields consumed by TimesFM and common build metadata."""
    ...
    def from_json(text: str) -> ModelConfig:
        ...
        return ModelConfig(
            model_type=data.get("model_type", "timesfm") or "timesfm",
            ...
            hidden_act=data.get("hidden_act", "relu") or "relu",
            _head_dim=int(data.get("head_dim", 0)),
            raw=data,
        )

    @classmethod
    def create_tiny(cls, model_type: str = "timesfm", **overrides) -> ModelConfig:
        data = {
