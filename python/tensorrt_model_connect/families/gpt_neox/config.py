...
@dataclass
class ModelConfig:
    """GPT-NeoX fields consumed by the family-owned builders."""
    ...
    def from_json(cls, text: str) -> ModelConfig:
        ...
        return cls(
            model_type=raw.get("model_type") or "gpt_neox",
            ...
            rms_norm_eps=(
                raw.get("layer_norm_eps")
                or raw.get("layer_norm_epsilon")
                or raw.get("rms_norm_eps")
                or 1e-5
            ),
    ...
    @classmethod
    def create_tiny(cls, model_type: str = "gpt_neox", **overrides) -> ModelConfig:
        values = {
