...
def add_squared_relu(
    network: trt.INetworkDefinition,
    inp: trt.ITensor,
) -> trt.ITensor:
    """Nemotron-4 MLP activation: ``relu(x) ** 2``."""
...
def add_layer_norm_native(
    ...
    """Apply Nemotron LayerNorm through TensorRT's native normalization layer."""
...
def make_rope_table_half_dim(
    ...
    """Build Nemotron's partial, rotate-half RoPE cosine or sine table."""
...
def add_apply_rope_native(
    ...
    """Apply Nemotron's partial, non-interleaved RoPE."""
...
def add_attention_core(
    ...
    """Build Nemotron's explicitly masked native scaled attention."""
...
def add_attention_from_rows(
    ...
    *,
    ...
    """Native GQA attention for row-major Nemotron Q/K/V tensors."""
    attention_size = num_heads * head_dim
...
def apply_norm(
    ...
    """Apply Nemotron's LayerNorm1P weights and optional bias."""
    if beta is None:
...
def add_attention_block(
    ...
    *,
    ...
    """Build Nemotron-4 pre-norm GQA with partial RoPE."""
...
def add_gelu_fc_mlp(
    ...
    *,
    ...
    """Build Nemotron's two-projection squared-ReLU MLP."""
    matmul = _make_matmul_fn(network, dtype, quant_ctx)
    ...
    activated = add_squared_relu(network, fc1)
...
def build_standard_decoder_engine(
    ...
    *,
    ...
    """Build Nemotron-4 decode or split prefill/decode engine plans."""
    import os as _os
...
def _add_decoder_layer(
    *,
    ...
    """Add one sequential Nemotron-4 decoder layer."""
...
def _validate_weights(weights: "WeightDict") -> None:
    """Reject incomplete Nemotron weight maps before building profiles."""
...
def build_dual_profile_decoder_engine(
    ...
    *,
    ...
    """Build Nemotron prefill/decode profiles for dynamic prompt length."""
