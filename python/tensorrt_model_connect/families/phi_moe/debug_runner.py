...
"""Stable family-owned entry point for the Phi-MoE debug runtime."""
...
def load_section_from_bundle(bundle_path: str, section_name: str) -> bytes | None:
    """Load a named raw section from a Phi-MoE bundle."""
...
def load_config_from_bundle(bundle_path: str) -> dict:
    """Load the embedded Phi-MoE config, when present."""
