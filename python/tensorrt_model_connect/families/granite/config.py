...
@dataclass
class ModelConfig:
    """Granite fields consumed by the family-owned weight and graph builders."""
    ...
    def from_json(cls, text: str) -> ModelConfig:
        ...
        return cls(
            model_type=raw.get("model_type") or "granite",
    ...
    @classmethod
    def create_tiny(cls, model_type: str = "granite", **overrides) -> ModelConfig:
        values = {
