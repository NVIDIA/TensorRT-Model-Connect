...
@dataclass
class ModelConfig:
    """Fields consumed by the ConvBERT encoder and TP builders."""

    model_type: str = "convbert"
    ...
    def from_json(text: str) -> ModelConfig:
        ...
        return ModelConfig(
            model_type=data.get("model_type", "convbert") or "convbert",
    ...
    @classmethod
    def create_tiny(cls, model_type: str = "convbert", **overrides) -> ModelConfig:
        data = {
