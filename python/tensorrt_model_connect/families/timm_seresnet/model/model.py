...
"""TensorRT graph builders for timm SE-ResNet classifiers.

This is the ResNet op set plus a squeeze-and-excite gate applied to the block
output before the residual add. The gate uses a ReLU inner activation and a
plain sigmoid.
"""
...
def add_squeeze_excite(
    ...
    *,
    ...
    """Squeeze-and-excite gate: mean, 1x1 reduce with ReLU, 1x1 expand, sigmoid.

    timm names the two projections fc1 and fc2 even though both are 1x1
    convolutions.
    """
