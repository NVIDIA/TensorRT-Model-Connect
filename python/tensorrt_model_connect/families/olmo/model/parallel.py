...
"""OLMo tensor-parallel prefill/decode engine builder."""
...
def build_dual_profile_tp_decoder_engine(
    ...
    *,
    ...
    """Build a rank-local OLMo engine with prefill/decode profiles."""
    ...
    for layer_idx in range(num_layers):
        ...
        norm2 = graph_ops.add_layer_norm(
            network,
    ...
    if verbose:
        print(
            "[trtmc build] Building OLMo tensor-parallel engine "
