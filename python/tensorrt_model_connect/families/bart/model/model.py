...
"""TensorRT graph helpers for BART's fixed post-norm architecture."""
...
def add_attention_core(
    ...
    """BART scaled dot-product attention, optionally with an additive mask."""
...
def add_attention_from_rows(
    ...
    *,
    ...
    """BART multi-head attention for row-major Q/K/V tensors."""
    attention_size = num_heads * head_dim
    q_4d = reshape_rows_to_heads_4d(network, q, num_heads, head_dim, q_seq)
    k_4d = reshape_rows_to_heads_4d(network, k, num_heads, head_dim, kv_seq)
    v_4d = reshape_rows_to_heads_4d(network, v, num_heads, head_dim, kv_seq)
    ctx_4d = add_attention_core(network, q_4d, k_4d, v_4d, mask=mask)
