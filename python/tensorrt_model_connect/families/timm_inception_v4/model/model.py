...
"""TensorRT graph builders for timm Inception-v4 classifiers.
...
its spatial size. Unlike Inception-v3, v4 excludes the zero padding from that
average, which changes only the border values.
"""
...
def add_avg_pool2d(network, x, kernel: int, stride: int, padding: int,
    ...
    """Average pool. Inception-v4 excludes the zero padding from the average."""
