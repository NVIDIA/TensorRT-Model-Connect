...
"""TensorRT graph builders for timm RepVGG classifiers.

RepVGG trains as a multi-branch block and is meant to run as a plain 3x3
convolution stack. The branches are fused on the host in the weight loader, so
the graph here needs nothing beyond convolution, ReLU, pooling, and a linear
head.
"""
