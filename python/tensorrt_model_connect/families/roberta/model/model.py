...
def add_attention_core(
    ...
    """Add RoBERTa's bidirectional scaled dot-product attention."""
...
def add_attention_from_rows(
    ...
    *,
    ...
    """Add RoBERTa attention for row-major Q/K/V tensors."""
...
def shard_encoder_weights(
    ...
    *,
    ...
    """Return the rank-local RoBERTa encoder weights."""
...
def build_encoder_engine(
    ...
    *,
    ...
    """Build a single-device or rank-local tensor-parallel RoBERTa engine."""
    ...
    if precision == "fp16":
        ...
        raise ValueError(f"Unsupported RoBERTa precision: {precision}")
    ...
    if verbose:
        print(
            f"[trtmc build] Building RoBERTa encoder TRT engine "
...
def build_tp_encoder_engine(
    ...
    *,
    ...
    """Build one rank-local RoBERTa engine."""
    parallel = normalize_parallel_config(parallel_config)
    if not parallel.enabled:
...
def _add_encoder_layer(
    *,
    ...
    """Add one bidirectional RoBERTa encoder layer with post-norm."""
    attention_size = num_heads * head_dim
