...
def build_canary_tp_decoder_engine(
    ...
    *,
    ...
    attention_mask = network.add_input("attention_mask", trt.float32, (-1, 1, attention_window))
    cross_attention_mask = network.add_input(
        "cross_attention_mask", trt.float32, (-1, 1, max_source_positions)
    )
    ...
    profile.set_shape("token_id", (1,), (16,), (CANARY_MAX_DECODER_LANES,))
    profile.set_shape("position_id", (1,), (16,), (CANARY_MAX_DECODER_LANES,))
    profile.set_shape(
        "attention_mask",
        (1, 1, attention_window),
