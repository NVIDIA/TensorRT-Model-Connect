...
@dataclass
class ModelConfig:
    """Llama fields consumed by the family-owned weight and graph builders."""
    ...
    def from_json(cls, text: str) -> ModelConfig:
        ...
        return cls(
            model_type=raw.get("model_type") or "llama",
    ...
    @classmethod
    def create_tiny(cls, model_type: str = "llama", **overrides) -> ModelConfig:
        values = {
