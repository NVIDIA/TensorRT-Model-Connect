...
"""TensorRT graph builders for timm Xception classifiers.

Xception is built from separable convolutions: a depthwise 3x3 followed by a
pointwise 1x1, each with its own batch norm. The op set is otherwise the plain
convolutional one.
"""
