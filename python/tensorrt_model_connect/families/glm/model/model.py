...
def add_attention_core(
    ...
    """Run GLM's scaled, additive-mask attention."""
...
def add_attention_block(
    ...
    *,
    ...
    """Build GLM pre-norm attention and the updated KV rows."""
...
def build_standard_decoder_engine(
    ...
    *,
    ...
    """Build a GLM decoder engine, including its debug and split-engine modes."""
    ...
    if verbose:
        print(
            f"[trtmc build] Building GLM engine ({num_layers} layers, hidden={hidden}, "
...
def build_dual_profile_decoder_engine(
    ...
    *,
    ...
    """Build GLM's prefill-only or combined prefill/decode engine."""
    ...
    if verbose:
        ...
        print(
            f"[trtmc build] Building {mode_label} GLM engine "
