...
@dataclass
class ModelConfig:
    """Fields consumed by the ELECTRA encoder and tensor-parallel builders."""
    ...
    def from_json(text: str) -> ModelConfig:
        ...
        return ModelConfig(
            model_type=data.get("model_type", "electra") or "electra",
    ...
    @classmethod
    def create_tiny(cls, model_type: str = "electra", **overrides) -> ModelConfig:
        data = {
