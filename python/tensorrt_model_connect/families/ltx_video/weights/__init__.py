...
"""Family-local checkpoint mapper for LTX-Video weights.

Loads HF safetensors and transposes projections from [out, in] to the
[in, out] layout used by the family-owned TensorRT builders.
"""
...
class WeightDict(dict):
    """Family-local mapping from logical weight names to arrays."""
