...
class TrackerMemoryFfiPlugin final : public nvinfer1::IPluginV2DynamicExt {
  public:
    TrackerMemoryFfiPlugin(std::string kernel_name, int32_t batch_size);
    TrackerMemoryFfiPlugin(const void* data, std::size_t length);
    ...
    TrackerMemoryFfiPlugin* clone() const noexcept override;
    ...
    static constexpr int32_t kMemoryChannels = 64;
