...
def build_ltx_vae_decoder_engine(
    ...
    *,
    ...
    debug_outputs = os.environ.get("TRTMC_LTX_VAE_DEBUG", "0") == "1"
...
def _add_torch_conv3d(
    ...
    *,
    ...
    creator = _get_sana_wm_plugin_creator_with_get_creator(trt_module, "SanaWmTorchConv3d")
    if creator is None:
...
def _add_vae_rms_silu(
    ...
    *,
    ...
    creator = _get_sana_wm_plugin_creator_with_get_creator(trt_module, "SanaWmVaeRmsSilu")
    if creator is None:
...
def _add_vae_denormalize(
    ...
    *,
    ...
    creator = _get_sana_wm_plugin_creator_with_get_creator(trt_module, "SanaWmVaeDenormalize")
    if creator is None:
...
def _add_vae_layer_norm(
    ...
    *,
    ...
    creator = _get_sana_wm_plugin_creator_with_get_creator(trt_module, "SanaWmVaeLayerNorm")
    if creator is None:
...
def _denormalize_ltx_latents(
    ...
    *,
    ...
    out_dtype = inp.dtype
    trt_module = _ensure_trt()
    if hasattr(trt_module, "bfloat16") and out_dtype == trt_module.bfloat16:
