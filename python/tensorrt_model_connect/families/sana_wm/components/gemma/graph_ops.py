...
def add_sana_wm_gemma_rms_norm(
    ...
    fields = [
        trt.PluginField(
            "eps", np.asarray([eps], dtype=np.float32), trt.PluginFieldType.FLOAT32
        )
    ]
    plugin = creator.create_plugin(
        "sana_wm_gemma_rms_norm", trt.PluginFieldCollection(fields)
    )
...
def add_sana_wm_gemma_gated_gelu(
    ...
    plugin = creator.create_plugin(
        "sana_wm_gemma_gated_gelu", trt.PluginFieldCollection([])
    )
...
def add_sana_wm_gemma_rope(
    ...
    plugin = creator.create_plugin(
        "sana_wm_gemma_rope", trt.PluginFieldCollection(fields)
    )
...
def add_sana_wm_gemma_attention(
    ...
    *,
    ...
    plugin = creator.create_plugin(
        "sana_wm_gemma_attention", trt.PluginFieldCollection(fields)
    )
