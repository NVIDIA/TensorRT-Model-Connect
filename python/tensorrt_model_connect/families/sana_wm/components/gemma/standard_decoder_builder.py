...
def _has_gemma_post_feedforward_norms(weights: "WeightDict", prefix: str) -> bool:
    return (
...
def _add_decoder_layer(
    *,
    ...
    gemma2_norms = _has_gemma_post_feedforward_norms(weights, prefix)
