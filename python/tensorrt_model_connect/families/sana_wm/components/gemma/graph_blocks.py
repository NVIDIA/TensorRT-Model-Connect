    ...
    *,
    ...
    if use_native_attention:
        ...
        context = graph_ops.add_attention_from_rows(
            ...
            logit_softcap=attention_softcap,
        )
...
def add_swiglu_mlp(
    ...
    *,
    ...
    activated_gate = graph_ops.add_activation(network, gate, activation, dtype=dtype)
    gated = network.add_elementwise(activated_gate, up, trt.ElementWiseOperation.PROD)
