...
"""InternLM family model configuration."""
...
@dataclass
class ModelConfig:
    """InternLM2 fields consumed by builders and bundle metadata."""
    ...
    def from_json(text: str) -> ModelConfig:
        ...
        return ModelConfig(
            model_type=data.get("model_type", "internlm2") or "internlm2",
    ...
    @classmethod
    def create_tiny(cls, model_type: str = "internlm2", **overrides) -> ModelConfig:
        data = {
