...
"""InternLM2 tensor-parallel prefill/decode engine builder."""
...
def build_dual_profile_tp_decoder_engine(
    ...
    *,
    ...
    """Build one rank-local InternLM2 engine with prefill/decode profiles."""
    ...
    if verbose:
        print(
            f"[trtmc-build] Building tensor-parallel decoder engine "
