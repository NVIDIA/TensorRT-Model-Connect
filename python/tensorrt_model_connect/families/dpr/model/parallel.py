...
"""Tensor-parallel DPR encoder engine builder.
...
def shard_encoder_weights(
    ...
    *,
    ...
    """Return rank-local DPR encoder weights for the TP builder."""
...
def build_tp_encoder_engine(
    ...
    *,
    ...
    """Build a rank-local TRT engine plan for a DPR encoder.
