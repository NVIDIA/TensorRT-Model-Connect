...
def reshape_rows_to_heads_4d(
    ...
    """Reshape DPR rows from [S, H * D] to [1, H, S, D]."""
...
def add_attention_core(
    ...
    """Add non-causal scaled dot-product attention for DPR."""
...
def add_attention_from_rows(
    ...
    *,
    ...
    """Apply DPR MHA to row-major [S, H * D] Q/K/V tensors."""
...
def build_encoder_engine(
    ...
    *,
    ...
    if precision == "fp16":
        ...
        raise ValueError(f"Unsupported DPR precision: {precision}")
