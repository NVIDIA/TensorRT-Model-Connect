...
@dataclass
class ModelConfig:
    """StarCoder2 fields consumed by the family-owned weight and graph builders."""
    ...
    def from_json(cls, text: str) -> ModelConfig:
        ...
        return cls(
            model_type=raw.get("model_type") or "starcoder2",
            ...
            rms_norm_eps=raw.get("norm_epsilon") or 1e-5,
