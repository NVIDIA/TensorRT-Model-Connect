...
"""MPNet family model configuration."""
...
@dataclass
class ModelConfig:
    """Fields consumed by the MPNet encoder and tensor-parallel builders."""
    ...
    def from_json(text: str) -> ModelConfig:
        ...
        return ModelConfig(
            model_type=data.get("model_type", "mpnet") or "mpnet",
            ...
            rms_norm_eps=float(data.get("layer_norm_eps", data.get("layer_norm_epsilon", 1e-5))),
            max_position_embeddings=int(data.get("max_position_embeddings", 514)),
    ...
    @classmethod
    def create_tiny(cls, model_type: str = "mpnet", **overrides) -> ModelConfig:
        data = {
