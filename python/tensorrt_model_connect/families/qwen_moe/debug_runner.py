...
"""Stable family-owned entry point for the Qwen-MoE debug runtime."""
...
def load_section_from_bundle(bundle_path: str, section_name: str) -> bytes | None:
    """Load a named raw section from a Qwen-MoE bundle."""
...
def load_config_from_bundle(bundle_path: str) -> dict:
    """Load the embedded Qwen-MoE config, when present."""
