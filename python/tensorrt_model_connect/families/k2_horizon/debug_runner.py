...
"""Family-owned fixed-step debug runner for native K2-Horizon bundles."""
...
def runner_from_bundle(
    *,
    ...
    if engine_plan is None or header is None:
    ...
    expected = "k2_horizon_decoder_kv_cache"
    if runtime_strategy != expected:
        raise ValueError(
            f"K2-Horizon debug runner requires runtime_strategy={expected!r}, got {runtime_strategy!r}"
        )
