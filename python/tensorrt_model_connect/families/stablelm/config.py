...
"""StableLM-2 model configuration consumed by the family-owned builder."""
...
class ModelConfig:
    ...
    def from_json(text: str) -> ModelConfig:
        ...
        return ModelConfig(
            model_type=data.get("model_type", "stablelm") or "stablelm",
            ...
            hidden_act=data.get("hidden_act", "silu") or "silu",
            _head_dim=int(data.get("head_dim", 0)),
            raw=data,
        )

    @classmethod
    def create_tiny(cls, model_type: str = "stablelm", **overrides) -> ModelConfig:
        data = {
