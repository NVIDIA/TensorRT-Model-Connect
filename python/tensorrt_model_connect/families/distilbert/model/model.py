...
def reshape_rows_to_heads_4d(
    ...
    """Reshape DistilBERT rows from [S, H * D] to [1, H, S, D]."""
...
def add_attention_core(
    ...
    """Add non-causal scaled dot-product attention for DistilBERT."""
...
def add_attention_from_rows(
    ...
    *,
    ...
    """Apply DistilBERT MHA to row-major [S, H * D] Q/K/V tensors."""
