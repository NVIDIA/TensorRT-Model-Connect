...
def build_elf_flow_engine(
    ...
    *,
    ...
    cos_cache_fp32 = add_constant(
        network, cos_np.shape, cos_np, dtype=np.float32)
    sin_cache_fp32 = add_constant(
    ...
    proj = add_gelu_new(network, proj, dtype=final_dtype)
    logits = _dense(
