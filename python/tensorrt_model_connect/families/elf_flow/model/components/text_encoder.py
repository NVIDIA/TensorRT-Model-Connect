...
def build_t5_encoder_engine(
    ...
    *,
    ...
    for layer_idx in range(num_layers):
        ...
        ffn_out = graph_ops.add_matmul_rhs_constant(network, ffn_input, d_ff, d_model, w_fc2)
    ...
    # --- Build ---
    print(
        f"[elf-t5-encoder] Building TRT engine "
...
def load_jax_t5_encoder_weights(
    ...
    *,
    ...
    """
    from ...weights import WeightDict, _target_np_dtype
    ...
    for i in range(num_layers):
        ...
        if i == 0:
            weights["encoder.block.0.layer.0.SelfAttention.relative_attention_bias.weight"] = (
