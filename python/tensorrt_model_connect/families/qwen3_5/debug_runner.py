...
"""Stable family-owned entry point for the Qwen3.5 debug runtime."""
...
def load_section_from_bundle(bundle_path: str, section_name: str) -> bytes | None:
    """Load a named raw section from a Qwen3.5 bundle."""
...
def load_config_from_bundle(bundle_path: str) -> dict:
    """Load the embedded Qwen3.5 config, when present."""
