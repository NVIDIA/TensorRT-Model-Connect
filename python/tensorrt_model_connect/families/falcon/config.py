...
@dataclass
class ModelConfig:
    """Falcon fields consumed by the family-owned weight and graph builders."""
    ...
    def from_json(cls, text: str) -> ModelConfig:
        ...
        return cls(
            model_type=raw.get("model_type") or "falcon",
            ...
            hidden_act=raw.get("hidden_act") or raw.get("activation") or "",
            _head_dim=raw.get("head_dim", 0),
            raw=raw,
        )

    @classmethod
    def create_tiny(cls, model_type: str = "falcon", **overrides) -> ModelConfig:
        values = {
