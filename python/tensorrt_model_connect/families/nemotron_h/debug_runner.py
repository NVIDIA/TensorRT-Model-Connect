...
"""Stable family-owned entry point for the Nemotron-H debug runtime."""

import json
import struct

from .model.runtime import HybridTrtRunner, runner_from_bundle
...
def load_section_from_bundle(bundle_path: str, section_name: str) -> bytes | None:
    """Load a named raw section from a Nemotron-H bundle."""
...
def load_config_from_bundle(bundle_path: str) -> dict:
    """Load the embedded Nemotron-H config, when present."""
