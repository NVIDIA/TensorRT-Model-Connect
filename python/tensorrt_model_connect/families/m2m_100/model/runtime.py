...
"""M2M-100-owned debug runner adapter."""
...
def runner_from_bundle(
    *,
    ...
    return Seq2SeqTrtRunner(
        ...
        num_layers=config.get("decoder_layers", header.get("num_layers", 1)),
        max_cache_length=header["max_cache_length"],
        max_source_positions=header["max_cache_length"],
        decoder_start_token_id=config.get("decoder_start_token_id", 2),
