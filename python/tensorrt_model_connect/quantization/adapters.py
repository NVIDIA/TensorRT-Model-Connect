...
"""Model-neutral calibration adapter contracts and decoder defaults."""
...
class CalibrationAdapter(Protocol):
    """Bridge between a model's reference model and scale acquisition."""
    ...
    def load_calibration_model(
        ...
        """Return ``(model, aux)`` where aux is tokenizer or model-specific state."""
        ...
...
class AutoCausalLMCalibrationAdapter:
    """Default adapter for standard decoder models backed by HF causal LM."""
