...
//
// Composes: ITrtModule (decoder) + CodegenKvCache + ITokenizer for this runtime
...
#include "families/codegen/runtime/inference_state.h"
#include "families/codegen/runtime/sampler.h"
#include "families/codegen/runtime/task_config.h"
#include "families/codegen/runtime/tokenizer.h"
...
class CodegenTextGenerationPipeline final : public internal::IModel,
                                            public internal::ITextContinuation {
  public:
    CodegenTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
                                  std::unique_ptr<CodegenInferenceState> state,
                                  CodegenTextGenConfig config,
    ...
    std::vector<internal::TaskInstance> task_bindings() override {
        return {internal::bind<internal::ITextContinuation>(*this, codegen::text_config_fields())};
    }
