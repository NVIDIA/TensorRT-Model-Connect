...
from families.timm_resnest.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_resnest", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_resnest.classify", "precision": "fp16", "mode": "hf-eager",
