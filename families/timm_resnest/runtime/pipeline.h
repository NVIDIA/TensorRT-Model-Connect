...
class TimmResNeStImageClassificationPipeline final : public internal::IModel,
                                                     public internal::IImageToClassScores {
  public:
    explicit TimmResNeStImageClassificationPipeline(std::unique_ptr<ITrtModule> model,
                                                    TimmResNeStPreprocessConfig preprocess_config,
