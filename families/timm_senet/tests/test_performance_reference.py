...
from families.timm_senet.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_senet", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_senet.classify", "precision": "fp16", "mode": "hf-eager",
