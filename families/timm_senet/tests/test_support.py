...
"""Dependency-free semantic Task discovery for timm_senet."""

from families.timm_senet.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "senet154"}, model_index={}))
