...
//
// Composes: ITrtModule (decoder) + PhiKvCache + ITokenizer for this runtime
...
#include "families/phi/runtime/inference_state.h"
#include "families/phi/runtime/sampler.h"
#include "families/phi/runtime/tokenizer.h"
...
class PhiTextGenerationPipeline final : public ITextGeneration {
  public:
    PhiTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
