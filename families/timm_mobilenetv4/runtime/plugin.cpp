...
TimmMobilenetv4PreprocessConfig parse_config(const nlohmann::json& json) {
...
extern "C" trtmc::ITask* trtmc_create_family(const trtmc::FamilyContext& context) {
    ...
    auto config = trtmc::timm_mobilenetv4::parse_config(metadata);
    auto engine = trtmc::timm_mobilenetv4::load_engine(context.backend, plan);
    return new trtmc::TimmMobilenetv4ImageClassificationPipeline(
