...
//
// Composes: ITrtModule (decoder) + MixtralKvCache + ITokenizer for this runtime
...
#include "families/mixtral/runtime/inference_state.h"
#include "families/mixtral/runtime/sampler.h"
#include "families/mixtral/runtime/tokenizer.h"
...
class MixtralTextGenerationPipeline final : public ITextGeneration {
  public:
    MixtralTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
                                  std::unique_ptr<MixtralInferenceState> state,
                                  MixtralTextGenConfig config,
