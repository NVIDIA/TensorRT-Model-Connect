...
eng = importlib.import_module(
    "families.minimax_music3.engines"
)
parity = importlib.import_module(
    "families.minimax_music3.parity"
)
spec = importlib.import_module(
    "families.minimax_music3.pipeline_spec"
)
...
def test_language_model_io_is_a_cached_decode_step() -> None:
    ...
    from families.minimax_music3 import language_model_engine as lme
...
def test_depth_decoder_io_carries_the_whole_frame() -> None:
    ...
    from families.minimax_music3 import depth_decoder_engine as dde
