...
from families.timm_ghostnet.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_ghostnet", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_ghostnet.classify", "precision": "fp16", "mode": "hf-eager",
