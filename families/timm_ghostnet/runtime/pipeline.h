...
class TimmGhostNetImageClassificationPipeline final : public internal::IModel,
                                                      public internal::IImageToClassScores {
  public:
    explicit TimmGhostNetImageClassificationPipeline(std::unique_ptr<ITrtModule> model,
                                                     TimmGhostNetPreprocessConfig preprocess_config,
