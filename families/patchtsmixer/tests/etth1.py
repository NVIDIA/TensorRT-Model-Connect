...
"""PatchTSMixer-owned ETTh1 nightly windows."""
...
CASE = "patchtsmixer-granite-official"
GATES = {"relative_l2": 5.0e-4, "max_pointwise_error": 2.5e-2}
_COLUMNS = ("HUFL", "HULL", "MUFL", "MULL", "LUFL", "LULL", "OT")
_CONTEXT = 512
_PREDICTION = 96
...
def windows() -> tuple[dict, ...]:
    ...
    assert root, "selected PatchTSMixer ETTh1 E2E requires TRTMC_REFERENCE_SOURCE_DIR"
