...
from families.patchtsmixer.tests.etth1 import GATES, _starts, windows


def test_etth1_selector_and_exact_gates() -> None:
    starts = _starts()
    assert starts == (13792, 13528, 12904, 11200, 12112, 13552, 11944, 12448, 12688, 13168)
    assert GATES == {"relative_l2": 5.0e-4, "max_pointwise_error": 2.5e-2}
