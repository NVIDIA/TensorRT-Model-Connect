...
from families.timm_mobilenetv3.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_mobilenetv3", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_mobilenetv3.classify", "precision": "fp16", "mode": "hf-eager",
