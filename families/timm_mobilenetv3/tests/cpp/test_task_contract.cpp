...
trtmc::TimmMobilenetv3PreprocessConfig preprocessing() {
...
void test_binding_and_complete_owned_logits() {
    trtmc::internal::LabelScoresResult result;
    {
        ...
        trtmc::TimmMobilenetv3ImageClassificationPipeline model(std::move(module), preprocessing(),
                                                                5, "", {});
...
void test_metadata_and_invalid_inputs() {
    ...
    trtmc::TimmMobilenetv3ImageClassificationPipeline model(std::move(module), preprocessing(), 5,
