...
"""Dependency-free semantic Task discovery for timm MobileNetV3."""

from families.timm_mobilenetv3.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "mobilenetv3_large_100"}, model_index={}))
