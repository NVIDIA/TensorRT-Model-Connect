...
//
// Composes: ITrtModule (decoder) + GptNeoKvCache + ITokenizer for this runtime
...
#include "families/gpt_neo/runtime/inference_state.h"
#include "families/gpt_neo/runtime/sampler.h"
#include "families/gpt_neo/runtime/task_config.h"
#include "families/gpt_neo/runtime/tokenizer.h"
...
class GptNeoTextGenerationPipeline final : public internal::IModel,
                                           public internal::ITextContinuation {
  public:
    GptNeoTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
    ...
    std::vector<internal::TaskInstance> task_bindings() override {
        return {internal::bind<internal::ITextContinuation>(*this, gpt_neo::text_config_fields())};
    }
