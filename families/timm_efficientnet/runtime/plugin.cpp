...
TimmEfficientnetPreprocessConfig parse_config(const nlohmann::json& json) {
...
extern "C" trtmc::ITask* trtmc_create_family(const trtmc::FamilyContext& context) {
    ...
    auto config = trtmc::timm_efficientnet::parse_config(metadata);
    auto engine = trtmc::timm_efficientnet::load_engine(context.backend, plan);
    return new trtmc::TimmEfficientnetImageClassificationPipeline(
