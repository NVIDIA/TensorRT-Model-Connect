...
from families.timm_efficientnet.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_efficientnet", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_efficientnet.classify", "precision": "fp16", "mode": "hf-eager",
