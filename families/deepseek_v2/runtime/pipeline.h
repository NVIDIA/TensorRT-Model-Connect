...
//
// Composes: ITrtModule (decoder) + DeepseekV2KvCache + ITokenizer for this runtime
...
#include "families/deepseek_v2/runtime/inference_state.h"
...
class DeepseekV2TextGenerationPipeline final : public ITextGeneration {
  public:
    DeepseekV2TextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
                                     std::unique_ptr<DeepseekV2InferenceState> state,
                                     DeepseekV2TextGenConfig config,
