...
from families.timm_swin.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_swin", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_swin.classify", "precision": "fp16", "mode": "hf-eager",
