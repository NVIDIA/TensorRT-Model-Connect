...
//
// Composes: ITrtModule (decoder) + StablelmKvCache + ITokenizer for this runtime
...
#include "families/stablelm/runtime/inference_state.h"
#include "families/stablelm/runtime/sampler.h"
#include "families/stablelm/runtime/tokenizer.h"
...
class StablelmTextGenerationPipeline final : public ITextGeneration {
  public:
    StablelmTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
                                   std::unique_ptr<StablelmInferenceState> state,
                                   StablelmTextGenConfig config,
