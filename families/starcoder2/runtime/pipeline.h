...
//
// Composes: ITrtModule (decoder) + Starcoder2KvCache + ITokenizer for this runtime
...
#include "families/starcoder2/runtime/inference_state.h"
#include "families/starcoder2/runtime/sampler.h"
...
class Starcoder2TextGenerationPipeline final : public ITextGeneration {
  public:
    Starcoder2TextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
                                     std::unique_ptr<Starcoder2InferenceState> state,
                                     Starcoder2TextGenConfig config,
