...
//
// Composes: ITrtModule (decoder) + QwenMoeKvCache + ITokenizer for this runtime
...
#include "families/qwen_moe/runtime/sampler.h"
#include "families/qwen_moe/runtime/tokenizer.h"
...
class QwenMoeTextGenerationPipeline final : public ITextGeneration {
  public:
    QwenMoeTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
                                  std::unique_ptr<QwenMoeInferenceState> state,
                                  QwenMoeTextGenConfig config,
