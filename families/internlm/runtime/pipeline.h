...
//
// Composes: ITrtModule (decoder) + InternlmKvCache + ITokenizer for this runtime
...
#include "families/internlm/runtime/inference_state.h"
#include "families/internlm/runtime/sampler.h"
#include "families/internlm/runtime/tokenizer.h"
...
class InternlmTextGenerationPipeline final : public ITextGeneration {
  public:
    InternlmTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
  ...
  private:
    ...
    std::unique_ptr<InternlmInferenceState> state_;
