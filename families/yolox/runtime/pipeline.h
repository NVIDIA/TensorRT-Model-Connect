...
class YoloxObjectDetectionPipeline final : public IObjectDetection {
  public:
    YoloxObjectDetectionPipeline(std::unique_ptr<ITrtModule> model,
                                 YoloxPreprocessConfig preprocess_config, float score_threshold,
  ...
  private:
    ...
    YoloxPreprocessConfig preprocess_config_;
