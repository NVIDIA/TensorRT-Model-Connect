...
//
// Composes: ITrtModule (decoder) + MistralKvCache + ITokenizer for this runtime
...
#include "families/mistral/runtime/inference_state.h"
#include "families/mistral/runtime/sampler.h"
#include "families/mistral/runtime/tokenizer.h"
...
class MistralTextGenerationPipeline final : public ITextGeneration {
  public:
    MistralTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
