...
"""Dependency-free semantic Task discovery for timm_res2net."""

from families.timm_res2net.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "res2net50_26w_4s"}, model_index={}))
