...
from families.timm_res2net.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_res2net", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_res2net.classify", "precision": "fp16", "mode": "hf-eager",
