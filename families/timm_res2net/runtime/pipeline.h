...
class TimmRes2NetImageClassificationPipeline final : public internal::IModel,
                                                     public internal::IImageToClassScores {
  public:
    explicit TimmRes2NetImageClassificationPipeline(std::unique_ptr<ITrtModule> model,
                                                    TimmRes2NetPreprocessConfig preprocess_config,
