...
from families.timm_inception.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_inception", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_inception.classify", "precision": "fp16", "mode": "hf-eager",
