...
"""Direct build, native-runtime, and official-reference E2E for timm_inception."""
...
import pytest
from families.timm_inception.cli import BuildRequest, build_bundle
...
def _assert_sdk_consumers(
    ...
    for language in ("c", "cpp"):
        consumer = native_build / f"test_timm_inception_sdk_{language}"
...
def test_official_checkpoint_e2e(case_name: str, tmp_path: Path) -> None:
    ...
    with evidence_stage("sdk"):
        _assert_sdk_consumers(runtime_root, bundle, case, config, expected, tmp_path)
