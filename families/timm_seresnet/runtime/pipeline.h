...
class TimmSEResNetImageClassificationPipeline final : public internal::IModel,
                                                      public internal::IImageToClassScores {
  public:
    explicit TimmSEResNetImageClassificationPipeline(std::unique_ptr<ITrtModule> model,
                                                     TimmSEResNetPreprocessConfig preprocess_config,
