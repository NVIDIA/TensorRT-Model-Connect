...
"""Dependency-free semantic Task discovery for timm_seresnet."""

from families.timm_seresnet.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "seresnet50"}, model_index={}))
