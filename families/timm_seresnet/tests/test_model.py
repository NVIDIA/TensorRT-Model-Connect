...
"""Focused contracts for timm SE-ResNet builds."""
...
from families.timm_seresnet import model  # noqa: E402
from families.timm_seresnet.checkpoint import Checkpoint  # noqa: E402
from families.timm_seresnet.support import describe  # noqa: E402
...
def test_support_claims_only_its_own_identity() -> None:
    assert describe(_metadata("seresnet50")) is not None
...
def test_read_config_rejects_another_family(tmp_path: Path) -> None:
    ...
    with pytest.raises(ValueError, match="unsupported timm SE-ResNet model identity"):
