...
from families.timm_seresnet.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_seresnet", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_seresnet.classify", "precision": "fp16", "mode": "hf-eager",
