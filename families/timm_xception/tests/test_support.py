...
"""Dependency-free semantic Task discovery for timm_xception."""

from families.timm_xception.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "xception41"}, model_index={}))
