...
from families.timm_xception.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_xception", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_xception.classify", "precision": "fp16", "mode": "hf-eager",
