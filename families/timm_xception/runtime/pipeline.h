...
class TimmXceptionImageClassificationPipeline final : public internal::IModel,
                                                      public internal::IImageToClassScores {
  public:
    explicit TimmXceptionImageClassificationPipeline(std::unique_ptr<ITrtModule> model,
                                                     TimmXceptionPreprocessConfig preprocess_config,
