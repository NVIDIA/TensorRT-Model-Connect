...
//
// Composes: ITrtModule (decoder) + Olmo2KvCache + ITokenizer for this runtime
...
#include "families/olmo2/runtime/inference_state.h"
#include "families/olmo2/runtime/sampler.h"
#include "families/olmo2/runtime/task_config.h"
#include "families/olmo2/runtime/tokenizer.h"
...
class Olmo2TextGenerationPipeline final : public internal::IModel,
                                          public internal::ITextContinuation {
  public:
    Olmo2TextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
                                std::unique_ptr<Olmo2InferenceState> state,
                                Olmo2TextGenConfig config, std::shared_ptr<ITokenizer> tokenizer,
    ...
    std::vector<internal::TaskInstance> task_bindings() override {
        return {internal::bind<internal::ITextContinuation>(*this, olmo2::text_config_fields())};
    }
