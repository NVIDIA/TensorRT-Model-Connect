...
from families.timm_hrnet.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_hrnet", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_hrnet.classify", "precision": "fp16", "mode": "hf-eager",
