...
"""Dependency-free semantic Task discovery for timm_hrnet."""

from families.timm_hrnet.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "hrnet_w18"}, model_index={}))
