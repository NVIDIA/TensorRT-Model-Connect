...
//
// Composes: ITrtModule (decoder) + NemotronKvCache + ITokenizer for this runtime
...
#include "families/nemotron/runtime/inference_state.h"
#include "families/nemotron/runtime/sampler.h"
#include "families/nemotron/runtime/tokenizer.h"
...
class NemotronTextGenerationPipeline final : public ITextGeneration {
  public:
    NemotronTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
                                   std::unique_ptr<NemotronInferenceState> state,
                                   NemotronTextGenConfig config,
