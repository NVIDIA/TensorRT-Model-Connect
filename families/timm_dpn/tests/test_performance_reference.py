...
from families.timm_dpn.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_dpn", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_dpn.classify", "precision": "fp16", "mode": "hf-eager",
