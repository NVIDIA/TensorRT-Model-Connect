...
"""Dependency-free semantic Task discovery for timm_dpn."""

from families.timm_dpn.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "dpn68b"}, model_index={}))
