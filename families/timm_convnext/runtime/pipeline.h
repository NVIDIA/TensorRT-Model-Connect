...
class TimmConvNeXtImageClassificationPipeline final : public internal::IModel,
                                                      public internal::IImageToClassScores {
  public:
    explicit TimmConvNeXtImageClassificationPipeline(std::unique_ptr<ITrtModule> model,
                                                     TimmConvNeXtPreprocessConfig preprocess_config,
