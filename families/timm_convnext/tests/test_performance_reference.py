...
from families.timm_convnext.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_convnext", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_convnext.classify", "precision": "fp16", "mode": "hf-eager",
