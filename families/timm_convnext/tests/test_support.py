...
"""Dependency-free semantic Task discovery for timm ConvNeXt."""

from families.timm_convnext.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "convnext_tiny"}, model_index={}))
