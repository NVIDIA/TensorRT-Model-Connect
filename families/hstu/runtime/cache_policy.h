...
// Family-private versioned metadata, independent of the platform cache ABI.
// Scalars and lengths use explicit little-endian fixed-width encoding. Invalid
// signatures, oversized token counts, malformed/truncated payloads and trailing
// bytes throw std::invalid_argument. Namespace strings retain arbitrary bytes.
