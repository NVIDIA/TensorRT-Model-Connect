...
//
// Composes: ITrtModule (decoder) + LlamaKvCache + ITokenizer for this runtime
...
#include "families/llama/runtime/sampler.h"
...
class LlamaTextGenerationPipeline final : public ITextGeneration {
  public:
    LlamaTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
                                std::unique_ptr<LlamaInferenceState> state,
                                LlamaTextGenConfig config, std::shared_ptr<ITokenizer> tokenizer,
