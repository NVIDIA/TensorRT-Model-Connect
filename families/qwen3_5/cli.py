...
"""qwen3_5-owned build command and typed inputs; importing this module is CPU-only."""
...
def build(
    *, model: str, output: Path, revision: str | None = None,
    ...
    resolve_family(load_model_metadata(model_dir), "qwen3_5")
    request = BuildRequest(
        model_dir=model_dir, output_path=output, family="qwen3_5",
