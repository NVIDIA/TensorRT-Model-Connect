...
"""Direct build, native-runtime, and official-reference E2E for timm_mobilenetv2."""
...
import pytest
from families.timm_mobilenetv2.cli import BuildRequest, build_bundle
...
def _assert_sdk_consumers(
    ...
    for language in ("c", "cpp"):
        consumer = native_build / f"test_timm_mobilenetv2_sdk_{language}"
