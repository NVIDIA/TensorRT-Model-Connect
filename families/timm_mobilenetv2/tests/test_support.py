...
"""Dependency-free semantic Task discovery for timm MobileNetV2."""

from families.timm_mobilenetv2.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "mobilenetv2_100"}, model_index={}))
