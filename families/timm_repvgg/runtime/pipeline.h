...
class TimmRepvggImageClassificationPipeline final : public internal::IModel,
                                                    public internal::IImageToClassScores {
  public:
    explicit TimmRepvggImageClassificationPipeline(std::unique_ptr<ITrtModule> model,
                                                   TimmRepvggPreprocessConfig preprocess_config,
