...
from families.timm_repvgg.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_repvgg", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_repvgg.classify", "precision": "fp16", "mode": "hf-eager",
