...
class TimmResnetImageClassificationPipeline final : public internal::IModel,
                                                    public internal::IImageToClassScores {
  public:
    explicit TimmResnetImageClassificationPipeline(std::unique_ptr<ITrtModule> model,
                                                   TimmResnetPreprocessConfig preprocess_config,
