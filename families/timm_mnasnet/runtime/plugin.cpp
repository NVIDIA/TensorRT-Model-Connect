...
TimmMnasnetPreprocessConfig parse_config(const std::vector<char>& data) {
...
TRTMC_DEFINE_FAMILY_PLUGIN_V1("timm_mnasnet")
...
extern "C" trtmc::ITask* trtmc_create_family(const trtmc::FamilyContext& context) {
    ...
    auto config = trtmc::timm_mnasnet::parse_config(config_data);
