...
"""Dependency-free semantic Task discovery for timm_mnasnet."""

from families.timm_mnasnet.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "mnasnet_100"}, model_index={}))
