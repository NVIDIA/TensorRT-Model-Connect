...
from families.timm_mnasnet.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_mnasnet", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_mnasnet.classify", "precision": "fp16", "mode": "hf-eager",
