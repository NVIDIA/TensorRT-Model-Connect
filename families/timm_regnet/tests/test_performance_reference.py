...
from families.timm_regnet.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_regnet", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_regnet.classify", "precision": "fp16", "mode": "hf-eager",
