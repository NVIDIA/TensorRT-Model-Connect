...
from families.timm_nfnet.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_nfnet", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_nfnet.classify", "precision": "fp16", "mode": "hf-eager",
