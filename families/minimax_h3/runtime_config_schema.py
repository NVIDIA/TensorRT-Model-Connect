...
_VALIDATORS = {
    ...
    "quantized_ref_transformer": lambda value: isinstance(value, str),
    "quantized_text_encoder": lambda value: isinstance(value, str),
    "super_resolution": lambda value: isinstance(value, bool),
