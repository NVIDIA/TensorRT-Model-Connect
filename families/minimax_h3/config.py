...
Production uses one dynamic profile for the complete released 5--15 second
T2VA and FL2VA media envelope. It supports dynamic prompt lengths, the public
continuous 1:4--4:1 canvas resolver, and the documented explicit performance
canvases, including the optional landscape 480p super-resolution source geometry.
...
# Each production FirstBlockCache engine has one profile covering the complete
# public 5--15 second envelope, including dynamic prompts and keyframes.
