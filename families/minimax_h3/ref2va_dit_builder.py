...
The full BF16 and INT8 ConvRot checkpoints use this same graph and binding ABI.
Quantized weights stay as ConvRotInt8Weight objects through the shared native
linear and fused-QKV operations; BF16 residual bindings are not BF16 weights.
"""
