...
def test_audio_encoder_public_profile_and_partition() -> None:
    _configure_trt()
    from families.minimax_h3.ref2va_audio_encoder_builder import (
...
def test_temporal_video_encoder_abi_reuses_visual_partition() -> None:
    _configure_trt()
    from families.minimax_h3.fl2va_vae_encoder_builder import (
        checkpoint_keys as visual_checkpoint_keys,
    )
    from families.minimax_h3.ref2va_video_encoder_builder import (
...
def test_ref2va_qwen_builders_delegate_to_shared_graphs_with_superset_profiles(
    ...
    from families.minimax_h3.ref2va_qwen_builder import (
