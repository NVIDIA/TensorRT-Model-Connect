...
from families.minimax_h3.tests import reporting
...
def test_paired_previews_keep_matched_indices_and_pixels(tmp_path: Path):
    ...
    expected = {"frames_path": reference_path}
    recorder = e2e_evidence.Evidence(tmp_path / "evidence", family="minimax_h3", case="preview-probe",
