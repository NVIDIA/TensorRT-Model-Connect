...
from families.minimax_h3.fl2va_contract import (
    LATENTS_MEAN,
    LATENTS_STD,
...
def test_checkpoint_partitions_are_exhaustive_and_fail_closed_when_trt_is_available() -> None:
    ...
    from families.minimax_h3.multimodal_text_encoder_builder import (
        build_multimodal_text_encoder_engine,
        checkpoint_keys as text_keys,
    )
    from families.minimax_h3.multimodal_vision_builder import (
