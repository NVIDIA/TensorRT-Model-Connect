...
"""Wan2.2-owned pure TensorRT UMT5 contracts."""
...
from families.wan2_2_ti2v import umt5_encoder_builder as umt5
...
def _tiny_native_state(model: umt5.Umt5EncoderConfig) -> dict[str, np.ndarray]:
    state = {}
