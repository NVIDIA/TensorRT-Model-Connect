...
def test_vl_runtime_config_uses_a_boolean_tokenizer_flag() -> None:
    config = SimpleNamespace(hidden_size=8, raw={})

    runtime = model_module._DeepseekOcrModel().get_vl_config(config)

    assert runtime["tokenizer_add_special_tokens"] is True
