...
from families.timm_vgg.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_vgg", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_vgg.classify", "precision": "fp16", "mode": "hf-eager",
