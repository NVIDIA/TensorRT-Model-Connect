...
"""TensorRT graph builders for timm VGG classifiers.

VGG is a plain convolutional stack: convolution with bias, ReLU, max pooling,
and a convolutional classifier head. There is no residual path and no batch
norm in the supported plain variants.
"""
...
def add_conv2d(
    ...
    *,
    ...
    Plain timm VGG checkpoints use convolution bias throughout the feature stack
    and classifier head.
    """
