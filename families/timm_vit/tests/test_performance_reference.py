...
from families.timm_vit.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_vit", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_vit.classify", "precision": "fp16", "mode": "hf-eager",
