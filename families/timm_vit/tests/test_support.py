...
"""Dependency-free semantic Task discovery for timm ViT."""

from families.timm_vit.support import describe
from tensorrt_model_connect.model_support import ModelMetadata


def test_primary_task_matches_the_semantic_runtime():
    support = describe(ModelMetadata(config={"architecture": "vit_base_patch16_224"}, model_index={}))
