...
//
// Composes: ITrtModule (decoder) + GraniteKvCache + ITokenizer for this runtime
...
#include "families/granite/runtime/inference_state.h"
#include "families/granite/runtime/sampler.h"
#include "families/granite/runtime/tokenizer.h"
...
class GraniteTextGenerationPipeline final : public ITextGeneration {
  public:
    GraniteTextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
                                  std::unique_ptr<GraniteInferenceState> state,
                                  GraniteTextGenConfig config,
  ...
  private:
    ...
    std::unique_ptr<GraniteInferenceState> state_;
