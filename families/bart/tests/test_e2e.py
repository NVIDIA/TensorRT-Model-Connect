...
"""Direct build, native-runtime, and official-reference E2E for bart."""
...
def _assert_parity(actual, expected, manifest: dict, case: dict, thresholds: dict) -> None:
    ...
    assert actual_text or expected_text
    limit = float(thresholds.get("contract_ned_threshold", 0.25))
    assert _edit_distance(actual_text, expected_text) <= limit
