...
#include "families/rwkv/runtime/inference_state.h"
#include "families/rwkv/runtime/sampler.h"
#include "families/rwkv/runtime/tokenizer.h"
...
class RecurrentPipeline final : public ITextGeneration {
  public:
    RecurrentPipeline(std::unique_ptr<ITrtModule> decoder,
                      std::unique_ptr<RwkvInferenceState> state, RecurrentGenConfig config,
