...
from families.timm_inception_resnet.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_inception_resnet", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_inception_resnet.classify", "precision": "fp16", "mode": "hf-eager",
