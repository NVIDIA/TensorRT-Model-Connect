...
trtmc::TimmInceptionResNetPreprocessConfig preprocessing() {
...
void test_binding_and_complete_owned_logits() {
    trtmc::internal::LabelScoresResult result;
    {
        ...
        trtmc::TimmInceptionResNetImageClassificationPipeline model(std::move(module),
                                                                    preprocessing(), 5, "", {});
...
void test_metadata_and_invalid_inputs() {
    ...
    trtmc::TimmInceptionResNetImageClassificationPipeline model(std::move(module), preprocessing(),
                                                                5, "test:five-classes", labels);
    const std::vector<float> pixels(12, 0.75F);
