...
//
// Composes: ITrtModule (decoder) + Gpt2KvCache + ITokenizer for this runtime
...
#include "families/gpt2/runtime/inference_state.h"
#include "families/gpt2/runtime/sampler.h"
#include "families/gpt2/runtime/task_config.h"
#include "families/gpt2/runtime/tokenizer.h"
...
class Gpt2TextGenerationPipeline final : public internal::IModel,
                                         public internal::ITextContinuation {
  public:
    Gpt2TextGenerationPipeline(std::unique_ptr<ITrtModule> decoder,
    ...
    std::vector<internal::TaskInstance> task_bindings() override {
        return {internal::bind<internal::ITextContinuation>(*this, gpt2::text_config_fields())};
    }
