...
from families.timm_xcit.tests import performance_reference as reference


def arguments(**updates):
    values = {
        "family": "timm_xcit", "operation": "classify",
        "selected_task": "image_to_class_scores", "model": "fixture/model",
        "case_name": "timm_xcit.classify", "precision": "fp16", "mode": "hf-eager",
