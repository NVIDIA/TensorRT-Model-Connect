...
TimmXCiTPreprocessConfig parse_config(const nlohmann::json& json) {
...
extern "C" trtmc::ITask* trtmc_create_family(const trtmc::FamilyContext& context) {
    ...
    auto config = trtmc::timm_xcit::parse_config(metadata);
    auto engine = trtmc::timm_xcit::load_engine(context.backend, plan);
    return new trtmc::TimmXCiTImageClassificationPipeline(
