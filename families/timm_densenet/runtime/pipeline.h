...
class TimmDensenetImageClassificationPipeline final : public internal::IModel,
                                                      public internal::IImageToClassScores {
  public:
    explicit TimmDensenetImageClassificationPipeline(std::unique_ptr<ITrtModule> model,
                                                     TimmDensenetPreprocessConfig preprocess_config,
