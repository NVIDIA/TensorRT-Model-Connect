...
## OpenFold3 prepared ubiquitin fixtures

The following files are deterministic, pickle-free build inputs generated by
`python/tensorrt_model_connect/families/openfold3/prepare_model_dir.py` from the
pinned public OpenFold3 v0.5.0 ubiquitin request and chemical-component
dictionary. They contain prepared numeric features and atom metadata, not model
weights or inference outputs, and are distributed under the Apache License 2.0
with the rest of the project:

- `tests/e2e/models/openfold3/data/openfold3_features.npz`; SHA-256
  `60a28fa84b8088849b96e67c16d537a6f79858229907736f381fdd5b100766c4`
- `tests/e2e/models/openfold3/data/openfold3_structure.json`; SHA-256
