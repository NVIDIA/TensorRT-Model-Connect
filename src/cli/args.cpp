...
void print_usage() {
    std::cerr
        << "Usage:\n"
           ...
           "  --runtime-cache PATH   Native TRT-RTX JIT cache file or optimized-runtime "
           "cache directory\n"
           "  --config FILE.json     Runtime config profile (route support varies)\n"
           "  --set NS.FIELD=VALUE   Runtime config override (repeatable; route support varies)\n"
