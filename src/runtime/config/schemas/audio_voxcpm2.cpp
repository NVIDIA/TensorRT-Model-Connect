...
Schema make_audio_voxcpm2_schema() {
    ...
    return Schema{
        "audio_voxcpm2",
        {
            ...
            ConfigField{"inference_timesteps", "int32", std::any{std::int32_t{10}},
            ...
            ConfigField{"retry_badcase_max_times", "int32", std::any{std::int32_t{3}},
                        session, is_nonneg_int32},
            ConfigField{"retry_badcase_ratio_threshold", "float", std::any{6.0F},
                        session, is_nonneg_float},
