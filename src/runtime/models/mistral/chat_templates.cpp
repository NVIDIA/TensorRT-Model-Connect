...
std::string mistral_detect_chat_template_format(const std::string& jinja_template) {
...
std::string mistral_apply_chat_template(const std::string& format, const std::string& prompt,
