...
inline std::string mistral_expand_layer_name(const std::string& pattern, int32_t layer) {
...
inline std::string mistral_layer_tensor_name(const char* stem, int32_t layer) {
