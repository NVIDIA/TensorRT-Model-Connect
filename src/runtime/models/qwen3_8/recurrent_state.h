...
class Qwen38RecurrentState final : public Qwen38InferenceState {
  public:
    struct TensorSpec {
        std::string name;
    ...
    Qwen38RecurrentState(int32_t num_layers, std::vector<TensorSpec> specs, cudaStream_t stream);
    ...
    const char* state_type() const override { return "qwen3_8_recurrent"; }
