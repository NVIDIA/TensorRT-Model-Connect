...
#include "runtime/models/qwen3_8/chat_templates.h"
...
std::string qwen3_8_detect_chat_template_format(const std::string& jinja_template) {
...
std::string qwen3_8_apply_chat_template(const std::string& format, const std::string& prompt,
