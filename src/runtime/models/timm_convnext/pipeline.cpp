...
TimmConvnextImageClassificationPipeline::TimmConvnextImageClassificationPipeline(
    std::unique_ptr<TrtModule> model, TimmConvnextPreprocessConfig preprocess_config,
...
ClassificationResult TimmConvnextImageClassificationPipeline::classify(const float* pixels,
                                                                       int32_t height,
                                                                       int32_t width) {
    auto pixel_values = preprocess_timm_convnext_image(pixels, height, width, preprocess_config_);
