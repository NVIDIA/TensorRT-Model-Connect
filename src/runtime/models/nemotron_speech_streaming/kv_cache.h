...
// NemotronSpeechStreamingKvCache: autoregressive KV cache state manager.
...
#include "runtime/models/nemotron_speech_streaming/inference_state.h"
...
struct NemotronSpeechStreamingKvCacheNames {
...
class NemotronSpeechStreamingKvCache : public NemotronSpeechStreamingInferenceState {
  public:
    ...
    NemotronSpeechStreamingKvCache(int32_t num_layers, int32_t max_length, int32_t kv_dim,
                                   cudaStream_t stream, DType cache_dtype = DType::kFloat32,
                                   NemotronSpeechStreamingKvCacheNames names = {});

    // --- NemotronSpeechStreamingInferenceState overrides ---
    void reset() override;
    ...
    // --- NemotronSpeechStreamingKvCache-specific methods (not on the interface) ---
    ...
    // — too big for NemotronSpeechStreamingKvCache's single-row present buffer. The caller reads
  ...
  private:
    ...
    NemotronSpeechStreamingKvCacheNames names_;
