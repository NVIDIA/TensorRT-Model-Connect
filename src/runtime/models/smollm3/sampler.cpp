...
#include "runtime/models/smollm3/sampler.h"

#include "trtmc/pipeline.h"
#if TRTMC_HAS_CUDA_KERNELS
#include "runtime/models/smollm3/argmax_kernel.h"
#include "runtime/models/smollm3/sparse_multinomial_kernel.h"
...
class GpuGreedySampler final : public Smollm3ISampler {
  public:
    ...
    Smollm3SampleResult sample(const float* logits, int32_t vocab_size,
        ...
        smollm3_gpu_argmax(logits, vocab_size, d_token_id_, d_logit_val_, stream_);
