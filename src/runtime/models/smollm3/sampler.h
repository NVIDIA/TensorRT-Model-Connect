...
// Smollm3ISampler: token selection abstraction for autoregressive generation.
//
...
//
// Smollm3LogitsLocation tells the pipeline whether to D2H transfer logits before
...
class Smollm3ISampler {
  public:
    ...
    virtual Smollm3LogitsLocation logits_location() const = 0;
...
/// Build Smollm3SamplingParams from GenerateConfig fields.
...
/// Factory: create sampler from Smollm3SamplingParams.
...
create_smollm3_sampler(const Smollm3SamplingParams& params,
                       const Smollm3SamplerFactoryOptions& options);
