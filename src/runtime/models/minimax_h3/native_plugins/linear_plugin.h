...
class MiniMaxH3LinearPlugin final : public nvinfer1::IPluginV3,
                                    public nvinfer1::IPluginV3OneCore,
                                    public nvinfer1::IPluginV3OneBuild,
                                    public nvinfer1::IPluginV3OneRuntime {
  public:
    explicit MiniMaxH3LinearPlugin(nvinfer1::PluginFieldCollection const& fields) noexcept;
    MiniMaxH3LinearPlugin(MiniMaxH3LinearPlugin const& other) noexcept;

    nvinfer1::IPluginCapability*
    getCapabilityInterface(nvinfer1::PluginCapabilityType type) noexcept override;
    MiniMaxH3LinearPlugin* clone() noexcept override;
    ...
    static constexpr nvinfer1::AsciiChar const* kPLUGIN_NAME = "MiniMaxH3Linear";
