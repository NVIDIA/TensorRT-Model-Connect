...
class MiniMaxH3LayerNormPlugin final : public nvinfer1::IPluginV3,
                                       public nvinfer1::IPluginV3OneCore,
                                       public nvinfer1::IPluginV3OneBuild,
                                       public nvinfer1::IPluginV3OneRuntime {
  public:
    explicit MiniMaxH3LayerNormPlugin(nvinfer1::PluginFieldCollection const& fields) noexcept;
    MiniMaxH3LayerNormPlugin(MiniMaxH3LayerNormPlugin const& other) noexcept;

    nvinfer1::IPluginCapability*
    getCapabilityInterface(nvinfer1::PluginCapabilityType type) noexcept override;
    MiniMaxH3LayerNormPlugin* clone() noexcept override;
    ...
    static constexpr nvinfer1::AsciiChar const* kPLUGIN_NAME = "MiniMaxH3LayerNorm";
