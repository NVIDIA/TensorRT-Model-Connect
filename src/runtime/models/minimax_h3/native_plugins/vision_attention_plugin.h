...
class MiniMaxH3VisionAttentionPlugin final : public nvinfer1::IPluginV3,
                                             public nvinfer1::IPluginV3OneCore,
                                             public nvinfer1::IPluginV3OneBuild,
                                             public nvinfer1::IPluginV3OneRuntime {
  public:
    explicit MiniMaxH3VisionAttentionPlugin(nvinfer1::PluginFieldCollection const& fields) noexcept;
    MiniMaxH3VisionAttentionPlugin(MiniMaxH3VisionAttentionPlugin const& other) noexcept;

    nvinfer1::IPluginCapability*
    getCapabilityInterface(nvinfer1::PluginCapabilityType type) noexcept override;
    MiniMaxH3VisionAttentionPlugin* clone() noexcept override;
    ...
    static constexpr nvinfer1::AsciiChar const* kPLUGIN_NAME = "MiniMaxH3VisionAttention";
    static constexpr nvinfer1::AsciiChar const* kPLUGIN_VERSION = "1";
    static constexpr int32_t kHEADS = 16;
    static constexpr int32_t kHEAD_DIM = 72;
    static constexpr int32_t kROW_WIDTH = kHEADS * kHEAD_DIM;
