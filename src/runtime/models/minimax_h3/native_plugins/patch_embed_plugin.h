...
class MiniMaxH3PatchEmbedPlugin final : public nvinfer1::IPluginV3,
                                        public nvinfer1::IPluginV3OneCore,
                                        public nvinfer1::IPluginV3OneBuild,
                                        public nvinfer1::IPluginV3OneRuntime {
  public:
    explicit MiniMaxH3PatchEmbedPlugin(nvinfer1::PluginFieldCollection const& fields) noexcept;
    MiniMaxH3PatchEmbedPlugin(MiniMaxH3PatchEmbedPlugin const& other) noexcept;

    nvinfer1::IPluginCapability*
    getCapabilityInterface(nvinfer1::PluginCapabilityType type) noexcept override;
    MiniMaxH3PatchEmbedPlugin* clone() noexcept override;
    ...
    static constexpr nvinfer1::AsciiChar const* kPLUGIN_NAME = "MiniMaxH3PatchEmbed";
    static constexpr nvinfer1::AsciiChar const* kPLUGIN_VERSION = "1";
    static constexpr int32_t kINPUT_CHANNELS = 3;
    static constexpr int32_t kTEMPORAL_PATCH = 2;
    static constexpr int32_t kSPATIAL_PATCH = 16;
    static constexpr int32_t kPIXEL_ROW_WIDTH =
        kINPUT_CHANNELS * kTEMPORAL_PATCH * kSPATIAL_PATCH * kSPATIAL_PATCH;
    static constexpr int32_t kOUTPUT_CHANNELS = 1152;
