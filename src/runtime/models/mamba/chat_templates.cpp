...
#include "runtime/models/mamba/chat_templates.h"
...
std::string mamba_detect_chat_template_format(const std::string& jinja_template) {
...
std::string mamba_apply_chat_template(const std::string& format, const std::string& prompt,
