...
class MambaRecurrentState final : public MambaInferenceState {
  public:
    struct TensorSpec {
        std::string name;
    ...
    MambaRecurrentState(int32_t num_layers, std::vector<TensorSpec> specs, cudaStream_t stream);
    ...
    const char* state_type() const override { return "mamba_recurrent"; }
