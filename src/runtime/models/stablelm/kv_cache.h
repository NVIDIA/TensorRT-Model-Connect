...
class StablelmKvCache : public StablelmInferenceState {
  public:
    ...
    StablelmKvCache(int32_t num_layers, int32_t max_length, int32_t kv_dim, cudaStream_t stream,
                    DType cache_dtype = DType::kFloat32, StablelmKvCacheNames names = {});

    // --- StablelmInferenceState overrides ---
    void reset() override;
    ...
    // --- StablelmKvCache-specific methods (not on the interface) ---
