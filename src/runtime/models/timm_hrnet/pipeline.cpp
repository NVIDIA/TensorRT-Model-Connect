...
TimmHrnetImageClassificationPipeline::TimmHrnetImageClassificationPipeline(
    std::unique_ptr<TrtModule> model, TimmHrnetPreprocessConfig preprocess_config,
...
ClassificationResult TimmHrnetImageClassificationPipeline::classify(const float* pixels,
    ...
    auto pixel_values = preprocess_timm_hrnet_image(pixels, height, width, preprocess_config_);
