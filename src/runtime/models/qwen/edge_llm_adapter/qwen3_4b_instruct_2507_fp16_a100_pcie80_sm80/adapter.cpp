...
constexpr const char* kImplementationId =
    "qwen3-4b-instruct-2507-fp16.tensorrt-edge-llm-v0.9.trt10.a100-pcie80-sm80";
constexpr const char* kModelId = "Qwen/Qwen3-4B-Instruct-2507";
constexpr const char* kModelRevision = "cdbee75f17c01a7cc42f958dc650907174af0554";
constexpr const char* kProfileId =
    "qwen3-4b-instruct-2507-fp16--a100-pcie80-sm80--edgellm0.9-trt10";
constexpr const char* kRuntimeLibrary =
    "libtrtmc_impl_qwen3_4b_instruct_2507_fp16_tensorrt_edge_llm_v0_9_trt10.so";
