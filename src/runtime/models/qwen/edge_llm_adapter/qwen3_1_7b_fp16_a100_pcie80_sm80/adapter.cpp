...
constexpr const char* kImplementationId =
    "qwen3-1.7b-fp16.tensorrt-edge-llm-v0.9.trt11.a100-pcie80-sm80";
constexpr const char* kModelId = "Qwen/Qwen3-1.7B";
constexpr const char* kModelRevision = "70d244cc86ccca08cf5af4e1e306ecf908b1ad5e";
constexpr const char* kProfileId = "qwen3-1.7b-fp16--a100-pcie80-sm80--edgellm0.9-trt11";
constexpr const char* kRuntimeLibrary =
    "libtrtmc_impl_qwen3_1_7b_fp16_tensorrt_edge_llm_v0_9_trt11.so";
