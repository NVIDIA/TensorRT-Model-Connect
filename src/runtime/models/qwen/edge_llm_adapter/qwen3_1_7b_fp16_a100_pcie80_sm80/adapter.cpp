...
constexpr const char* kImplementationId =
    "qwen3-1.7b-fp16.tensorrt-edge-llm-v0.9.trt10.a100-pcie80-sm80";
...
constexpr const char* kProfileId = "qwen3-1.7b-fp16--a100-pcie80-sm80--edgellm0.9-trt10";
constexpr const char* kRuntimeLibrary =
    "libtrtmc_impl_qwen3_1_7b_fp16_tensorrt_edge_llm_v0_9_trt10.so";
