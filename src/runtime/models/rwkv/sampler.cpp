...
class RwkvGreedySampler final : public RwkvISampler {
  public:
    ...
    RwkvLogitsLocation logits_location() const override { return RwkvLogitsLocation::HOST; }
    const char* sampler_type() const override { return "rwkv_greedy"; }
};
...
class RwkvTopKSampler final : public RwkvISampler {
  public:
    ...
    RwkvLogitsLocation logits_location() const override { return RwkvLogitsLocation::HOST; }
    const char* sampler_type() const override { return "rwkv_top_k"; }
