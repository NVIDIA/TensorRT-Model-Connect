...
class RwkvRecurrentState final : public RwkvInferenceState {
  public:
    struct TensorSpec {
        std::string name;
    ...
    RwkvRecurrentState(int32_t num_layers, std::vector<TensorSpec> specs, cudaStream_t stream);
    ...
    const char* state_type() const override { return "rwkv_recurrent"; }
