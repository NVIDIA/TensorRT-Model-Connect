...
TimmInceptionResnetImageClassificationPipeline::TimmInceptionResnetImageClassificationPipeline(
    std::unique_ptr<TrtModule> model, TimmInceptionResnetPreprocessConfig preprocess_config,
...
ClassificationResult TimmInceptionResnetImageClassificationPipeline::classify(const float* pixels,
                                                                              ...
                                                                              int32_t width) {
    auto pixel_values =
        preprocess_timm_inception_resnet_image(pixels, height, width, preprocess_config_);
