...
TimmSenetImageClassificationPipeline::TimmSenetImageClassificationPipeline(
    std::unique_ptr<TrtModule> model, TimmSenetPreprocessConfig preprocess_config,
...
ClassificationResult TimmSenetImageClassificationPipeline::classify(const float* pixels,
    ...
    auto pixel_values = preprocess_timm_senet_image(pixels, height, width, preprocess_config_);
