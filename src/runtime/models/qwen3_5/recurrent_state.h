...
class Qwen35RecurrentState final : public Qwen35InferenceState {
  public:
    struct TensorSpec {
        std::string name;
    ...
    Qwen35RecurrentState(int32_t num_layers, std::vector<TensorSpec> specs, cudaStream_t stream);
    ...
    const char* state_type() const override { return "qwen3_5_recurrent"; }
