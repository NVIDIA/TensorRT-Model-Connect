...
class Qwen3OmniRecurrentState final : public Qwen3OmniInferenceState {
  public:
    struct TensorSpec {
        std::string name;
    ...
    Qwen3OmniRecurrentState(int32_t num_layers, std::vector<TensorSpec> specs, cudaStream_t stream);
    ...
    const char* state_type() const override { return "qwen3_omni_recurrent"; }
