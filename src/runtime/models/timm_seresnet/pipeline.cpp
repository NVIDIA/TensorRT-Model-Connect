...
TimmSeresnetImageClassificationPipeline::TimmSeresnetImageClassificationPipeline(
    std::unique_ptr<TrtModule> model, TimmSeresnetPreprocessConfig preprocess_config,
...
ClassificationResult TimmSeresnetImageClassificationPipeline::classify(const float* pixels,
                                                                       int32_t height,
                                                                       int32_t width) {
    auto pixel_values = preprocess_timm_seresnet_image(pixels, height, width, preprocess_config_);
