...
// DeepseekV2ISampler: token selection abstraction for autoregressive generation.
//
...
//
// DeepseekV2LogitsLocation tells the pipeline whether to D2H transfer logits before
...
struct DeepseekV2SamplingParams {
...
/// deepseek_v2-owned sampler interface.
class DeepseekV2ISampler {
  public:
    virtual ~DeepseekV2ISampler() = default;
    ...
    virtual DeepseekV2SampleResult sample(const float* logits, int32_t vocab_size,
                                          const DeepseekV2SamplingParams& params) = 0;
    ...
    virtual DeepseekV2LogitsLocation logits_location() const = 0;
...
/// Build DeepseekV2SamplingParams from GenerateConfig fields.
...
/// Factory: create sampler from DeepseekV2SamplingParams.
...
std::unique_ptr<DeepseekV2ISampler>
create_deepseek_v2_sampler(const DeepseekV2SamplingParams& params,
                           const DeepseekV2SamplerFactoryOptions& options);
