...
bool deepseek_v2_triattention_score_candidates_gpu(
...
bool deepseek_v2_triattention_compact_rows_gpu(const void* d_src, void* d_scratch,
                                               DType cache_dtype, int32_t kv_dim,
                                               const int32_t* d_keep_indices, int32_t keep_count,
                                               int32_t head_dim, int32_t num_kv_heads,
