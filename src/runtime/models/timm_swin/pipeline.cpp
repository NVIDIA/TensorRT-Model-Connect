...
TimmSwinImageClassificationPipeline::TimmSwinImageClassificationPipeline(
    std::unique_ptr<TrtModule> model, TimmSwinPreprocessConfig preprocess_config,
...
ClassificationResult TimmSwinImageClassificationPipeline::classify(const float* pixels,
                                                                   int32_t height, int32_t width) {
    auto pixel_values = preprocess_timm_swin_image(pixels, height, width, preprocess_config_);
