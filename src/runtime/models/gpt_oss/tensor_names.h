...
inline std::string gpt_oss_expand_layer_name(const std::string& pattern, int32_t layer) {
...
inline std::string gpt_oss_layer_tensor_name(const char* stem, int32_t layer) {
