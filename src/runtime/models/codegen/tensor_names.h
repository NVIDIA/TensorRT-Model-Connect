...
inline std::string codegen_expand_layer_name(const std::string& pattern, int32_t layer) {
...
inline std::string codegen_layer_tensor_name(const char* stem, int32_t layer) {
