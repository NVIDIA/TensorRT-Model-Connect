...
// Wan22Ti2vInferenceState: unified interface for autoregressive inference state.
//
...
//
// Implementations:
//   Wan22Ti2vKvCache          — dense append-only (current default)
//   Family-owned recurrent state — recurrent tensor state
//   Family-owned hybrid state — Wan22Ti2vKvCache + family-owned recurrent state composed
...
class Wan22Ti2vInferenceState {
  public:
    virtual ~Wan22Ti2vInferenceState() = default;
    ...
    // Wan22Ti2vKvCache -> true. Family-owned recurrent state -> false.
