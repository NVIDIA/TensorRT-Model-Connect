...
// NemotronLabsDiffusionISampler: token selection abstraction for autoregressive generation.
//
...
//
// NemotronLabsDiffusionLogitsLocation tells the pipeline whether to D2H transfer logits before
...
struct NemotronLabsDiffusionSamplingParams {
...
struct NemotronLabsDiffusionSamplerFactoryOptions {
    bool prefer_torch_cuda_multinomial{true};
};

/// Where the sampler expects logits to live.
enum class NemotronLabsDiffusionLogitsLocation {
...
struct NemotronLabsDiffusionSampleResult {
    int32_t token_id{0};
...
/// nemotron_labs_diffusion-owned sampler interface.
class NemotronLabsDiffusionISampler {
  public:
    virtual ~NemotronLabsDiffusionISampler() = default;
    ...
    virtual NemotronLabsDiffusionSampleResult
    sample(const float* logits, int32_t vocab_size,
           const NemotronLabsDiffusionSamplingParams& params) = 0;
    ...
    virtual NemotronLabsDiffusionLogitsLocation logits_location() const = 0;
...
/// Build NemotronLabsDiffusionSamplingParams from GenerateConfig fields.
...
/// Factory: create sampler from NemotronLabsDiffusionSamplingParams.
...
std::unique_ptr<NemotronLabsDiffusionISampler>
create_nemotron_labs_diffusion_sampler(const NemotronLabsDiffusionSamplingParams& params,
                                       const NemotronLabsDiffusionSamplerFactoryOptions& options);
