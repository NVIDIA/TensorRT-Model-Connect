...
inline std::string gpt_neo_expand_layer_name(const std::string& pattern, int32_t layer) {
...
inline std::string gpt_neo_layer_tensor_name(const char* stem, int32_t layer) {
