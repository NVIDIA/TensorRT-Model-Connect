...
inline std::string phi4_multimodal_expand_layer_name(const std::string& pattern, int32_t layer) {
...
inline std::string phi4_multimodal_layer_tensor_name(const char* stem, int32_t layer) {
