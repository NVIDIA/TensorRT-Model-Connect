...
#include "runtime/models/phi4_multimodal/decoded_image.h"
...
struct Phi4MultimodalPreprocessConfig {
...
struct Phi4MultimodalPreprocessedImage {
...
runtime::adapters::io::DecodedImage phi4_multimodal_decode_image_rgb(const std::string& image_path);
...
Phi4MultimodalPreprocessedImage
phi4_multimodal_load_and_preprocess_image(const std::string& image_path,
                                          const Phi4MultimodalPreprocessConfig& config);
...
// Parse Phi4MultimodalPreprocessConfig from config.json text.
