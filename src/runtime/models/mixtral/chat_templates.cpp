...
std::string mixtral_detect_chat_template_format(const std::string& jinja_template) {
...
std::string mixtral_apply_chat_template(const std::string& format, const std::string& prompt,
