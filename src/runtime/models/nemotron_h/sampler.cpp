...
#include "runtime/models/nemotron_h/sampler.h"
...
class NemotronHGreedySampler final : public NemotronHISampler {
  public:
    ...
    NemotronHLogitsLocation logits_location() const override {
        return NemotronHLogitsLocation::HOST;
    }
    const char* sampler_type() const override { return "nemotron_h_greedy"; }
};
...
class NemotronHTopKSampler final : public NemotronHISampler {
  public:
    ...
    const char* sampler_type() const override { return "nemotron_h_top_k"; }
