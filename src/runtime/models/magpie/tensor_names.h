...
inline std::string magpie_expand_layer_name(const std::string& pattern, int32_t layer) {
...
inline std::string magpie_layer_tensor_name(const char* stem, int32_t layer) {
