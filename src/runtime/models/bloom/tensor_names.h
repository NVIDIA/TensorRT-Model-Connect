...
inline std::string bloom_expand_layer_name(const std::string& pattern, int32_t layer) {
...
inline std::string bloom_layer_tensor_name(const char* stem, int32_t layer) {
