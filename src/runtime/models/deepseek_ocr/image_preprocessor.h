...
#include "runtime/models/deepseek_ocr/decoded_image.h"
...
struct DeepseekOcrPreprocessConfig {
...
struct DeepseekOcrPreprocessedImage {
...
// Parse DeepseekOcrPreprocessConfig from config.json text.
