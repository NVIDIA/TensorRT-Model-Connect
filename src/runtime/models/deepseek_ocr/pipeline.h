...
// Composes: vision_encoder TrtModule + text_decoder TrtModule + DeepseekOcrKvCache.

#include "runtime/models/deepseek_ocr/image_preprocessor.h"
#include "runtime/models/deepseek_ocr/inference_state.h"
...
class DeepseekOcrPipeline final : public IPipeline {
  public:
    DeepseekOcrPipeline(std::unique_ptr<TrtModule> text_decoder,
    ...
    const char* pipeline_type() const override { return "DeepseekOcrPipeline"; }
  ...
  private:
    ...
    std::unique_ptr<DeepseekOcrISampler> sampler_;
