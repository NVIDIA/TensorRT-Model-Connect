...
inline std::string nemotron_expand_layer_name(const std::string& pattern, int32_t layer) {
...
inline std::string nemotron_layer_tensor_name(const char* stem, int32_t layer) {
