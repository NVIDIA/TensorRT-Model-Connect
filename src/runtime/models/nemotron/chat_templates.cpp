...
std::string nemotron_detect_chat_template_format(const std::string& jinja_template) {
...
std::string nemotron_apply_chat_template(const std::string& format, const std::string& prompt,
