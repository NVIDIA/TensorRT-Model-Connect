...
TimmXceptionImageClassificationPipeline::TimmXceptionImageClassificationPipeline(
    std::unique_ptr<TrtModule> model, TimmXceptionPreprocessConfig preprocess_config,
...
ClassificationResult TimmXceptionImageClassificationPipeline::classify(const float* pixels,
                                                                       int32_t height,
                                                                       int32_t width) {
    auto pixel_values = preprocess_timm_xception_image(pixels, height, width, preprocess_config_);
