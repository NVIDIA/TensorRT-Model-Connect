...
std::string starcoder2_detect_chat_template_format(const std::string& jinja_template) {
...
std::string starcoder2_apply_chat_template(const std::string& format, const std::string& prompt,
