...
#include "runtime/models/speech/speech_decode_stop_policy.h"
...
#include "runtime/models/speech/speech_mimi_decode_plan.h"
#include "runtime/models/speech/speech_runtime_plan.h"
#include "runtime/models/speech/speech_temporal_embed_plan.h"
#include "runtime/models/speech/speech_waveform_postprocess.h"
#include "runtime/models/speech/subprocess_runner.h"
...
int32_t speech_select_depth_token_sampled(const std::vector<float>& logits, const SpeechConfig& cfg,
                                          uint64_t& rng_state) {
    return sample_token_topk(logits, cfg.depth_temperature, cfg.depth_top_k, rng_state);
}
