...
class Lfm2GreedySampler final : public Lfm2ISampler {
  public:
    ...
    const char* sampler_type() const override { return "lfm2_greedy"; }
};
...
class Lfm2DistributionSampler final : public Lfm2ISampler {
  public:
    ...
    const char* sampler_type() const override { return "lfm2_distribution"; }
...
Lfm2SamplingParams
lfm2_sampling_params_from_config(const GenerateConfig& cfg,
