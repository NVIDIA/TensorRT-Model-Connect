...
#include "runtime/models/lfm2/inference_state.h"
...
class Lfm2TextGenerationPipeline final : public IPipeline {
  public:
    Lfm2TextGenerationPipeline(std::unique_ptr<TrtModule> decoder,
                               ...
                               std::string model_id = "",
                               std::unique_ptr<Lfm2ISampler> sampler = nullptr);
    ...
    const char* pipeline_type() const override { return "Lfm2TextGenerationPipeline"; }
  ...
  private:
    ...
    std::unique_ptr<Lfm2ISampler> sampler_;
