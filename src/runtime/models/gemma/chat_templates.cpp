...
std::string gemma_detect_chat_template_format(const std::string& jinja_template) {
...
std::string gemma_apply_chat_template(const std::string& format, const std::string& prompt,
